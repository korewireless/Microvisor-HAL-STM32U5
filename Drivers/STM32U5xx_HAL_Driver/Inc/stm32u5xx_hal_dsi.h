...
/**
  ...
  * @retval None.
  */
#define __HAL_DSI_ENABLE(__HANDLE__) MV_SET_BIT((__HANDLE__)->Instance->CR, DSI_CR_EN);
...
/**
  ...
  * @retval None.
  */
#define __HAL_DSI_DISABLE(__HANDLE__) MV_CLEAR_BIT((__HANDLE__)->Instance->CR, DSI_CR_EN);
...
/**
  ...
  * @retval None.
  */
#define __HAL_DSI_WRAPPER_ENABLE(__HANDLE__) MV_SET_BIT((__HANDLE__)->Instance->WCR, DSI_WCR_DSIEN);
...
/**
  ...
  * @retval None.
  */
#define __HAL_DSI_WRAPPER_DISABLE(__HANDLE__) MV_CLEAR_BIT((__HANDLE__)->Instance->WCR, DSI_WCR_DSIEN);
...
/**
  ...
  * @retval None.
  */
#define __HAL_DSI_PLL_ENABLE(__HANDLE__) MV_SET_BIT((__HANDLE__)->Instance->WRPCR, DSI_WRPCR_PLLEN);
...
/**
  ...
  * @retval None.
  */
#define __HAL_DSI_PLL_DISABLE(__HANDLE__) MV_CLEAR_BIT((__HANDLE__)->Instance->WRPCR, DSI_WRPCR_PLLEN);
