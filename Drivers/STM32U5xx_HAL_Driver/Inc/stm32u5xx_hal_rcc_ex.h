...
#define __HAL_RCC_MSI_CALIBRATIONVALUE_ADJUST(__MSICALIBRATIONVALUE__ , __MSIRANGE__) \
  ...
  { \
    ...
    {\
      MV_MODIFY_REG((RCC->ICSCR2), (RCC_ICSCR2_MSITRIM3), ((uint32_t)(__MSICALIBRATIONVALUE__)<<\
                                                        RCC_ICSCR2_MSITRIM3_Pos));\
    }\
    else if(__MSIRANGE__ >= RCC_MSIRANGE_8)\
    {\
      MV_MODIFY_REG((RCC->ICSCR2), (RCC_ICSCR2_MSITRIM2), ((uint32_t)(__MSICALIBRATIONVALUE__)<<\
                                                        RCC_ICSCR2_MSITRIM2_Pos));\
    }\
    else if(__MSIRANGE__ >= RCC_MSIRANGE_4)\
    {\
      MV_MODIFY_REG((RCC->ICSCR2), (RCC_ICSCR2_MSITRIM1), ((uint32_t)(__MSICALIBRATIONVALUE__)<<\
                                                        RCC_ICSCR2_MSITRIM1_Pos));\
    } \
    else /* if(__MSIRANGE__ >= RCC_MSIRANGE_0) */\
    { \
      MV_MODIFY_REG((RCC->ICSCR2), (RCC_ICSCR2_MSITRIM0), ((uint32_t)(__MSICALIBRATIONVALUE__)<<\
...
#define __HAL_RCC_TIMIC_CLK_CONFIG(__TIMICSOURCE__) \
  ...
  {                                                         \
    ...
    MV_MODIFY_REG(RCC->CCIPR1, RCC_CCIPR1_TIMICSEL,(0x00000000));               \
    /*Select TIMIC clock SOURCE*/                                            \
    MV_MODIFY_REG(RCC->CCIPR1, RCC_CCIPR1_TIMICSEL,(uint32_t)(__TIMICSOURCE__));\
  } while(0)

/** @brief  Macro to disable timer input capture clock source.
  * @retval None
  */
#define __HAL_RCC_TIMIC_CLK_DISABLE() MV_MODIFY_REG(RCC->CCIPR1, RCC_CCIPR1_TIMICSEL,(0x00000000))
...
/** @brief  Macros to enable or disable the PLL2.
  ...
  * @retval None
  */
#define __HAL_RCC_PLL2_ENABLE()  MV_SET_BIT(RCC->CR, RCC_CR_PLL2ON)
#define __HAL_RCC_PLL2_DISABLE() MV_CLEAR_BIT(RCC->CR, RCC_CR_PLL2ON)
...
/** @brief  Macro to configure the PLL2 clock source.
  ...
  */
#define __HAL_RCC_PLL2_PLLSOURCE_CONFIG(__PLL2SOURCE__) MV_MODIFY_REG(RCC->PLL2CFGR, RCC_PLL2CFGR_PLL2SRC,\
                                                                   (__PLL2SOURCE__))
...
#define __HAL_RCC_PLL2_CONFIG(__PLL2SOURCE__, __PLL2M__, __PLL2N__, __PLL2P__, __PLL2Q__, __PLL2R__) \
  do \
  { \
    MV_MODIFY_REG(RCC->PLL2CFGR,(RCC_PLL2CFGR_PLL2SRC|RCC_PLL2CFGR_PLL2M), ((__PLL2SOURCE__)<< RCC_PLL2CFGR_PLL2SRC_Pos) |\
               (((__PLL2M__) - 1U) << RCC_PLL2CFGR_PLL2M_Pos));\
    MV_MODIFY_REG(RCC->PLL2DIVR ,(RCC_PLL2DIVR_PLL2N|RCC_PLL2DIVR_PLL2P|RCC_PLL2DIVR_PLL2Q|\
...
/**
  ...
  * @retval None
  */
#define __HAL_RCC_PLL2CLKOUT_ENABLE(__PLL2_CLOCKOUT__)   MV_SET_BIT(RCC->PLL2CFGR, (__PLL2_CLOCKOUT__))
#define __HAL_RCC_PLL2CLKOUT_DISABLE(__PLL2_CLOCKOUT__)  MV_CLEAR_BIT(RCC->PLL2CFGR, (__PLL2_CLOCKOUT__))
...
/**
  ...
  * @retval SET / RESET
  */
#define __HAL_RCC_GET_PLL2CLKOUT_CONFIG(__PLL2_CLOCKOUT__)  MV_READ_BIT(RCC->PLL2CFGR, (__PLL2_CLOCKOUT__))
...
/**
  ...
  * @retval None
  */
#define __HAL_RCC_PLL2FRACN_ENABLE()   MV_SET_BIT(RCC->PLL2CFGR, RCC_PLL2CFGR_PLL2FRACEN)
#define __HAL_RCC_PLL2FRACN_DISABLE()  MV_CLEAR_BIT(RCC->PLL2CFGR, RCC_PLL2CFGR_PLL2FRACEN)
...
/**
  ...
  * @retval None
  */
#define  __HAL_RCC_PLL2FRACN_CONFIG(__PLL2FRACN__) MV_MODIFY_REG(RCC->PLL2FRACR, RCC_PLL2FRACR_PLL2FRACN,\
...
#define __HAL_RCC_PLL2_VCIRANGE(__PLL2VCIRange__) \
  MV_MODIFY_REG(RCC->PLL2CFGR, RCC_PLL2CFGR_PLL2RGE, (__PLL2VCIRange__))
...
/** @brief  Macros to enable or disable the main PLL3.
  ...
  */
#define __HAL_RCC_PLL3_ENABLE()  MV_SET_BIT(RCC->CR, RCC_CR_PLL3ON)
#define __HAL_RCC_PLL3_DISABLE() MV_CLEAR_BIT(RCC->CR, RCC_CR_PLL3ON)
...
/** @brief  Macro to configure the PLL3 clock source.
  ...
  *
  */
#define __HAL_RCC_PLL3_PLLSOURCE_CONFIG(__PLL3SOURCE__) MV_MODIFY_REG(RCC->PLL3CFGR, RCC_PLL3CFGR_PLL3SRC, \
                                                                   (__PLL3SOURCE__))
...
#define __HAL_RCC_PLL3_CONFIG(__PLL3SOURCE__, __PLL3M__, __PLL3N__, __PLL3P__, __PLL3Q__, __PLL3R__) \
  do\
  {\
    MV_MODIFY_REG(RCC->PLL3CFGR,(RCC_PLL3CFGR_PLL3SRC|RCC_PLL3CFGR_PLL3M), ((__PLL3SOURCE__) << RCC_PLL3CFGR_PLL3SRC_Pos)|\
               (((__PLL3M__) - 1U) << RCC_PLL3CFGR_PLL3M_Pos));\
    MV_MODIFY_REG(RCC->PLL3DIVR ,(RCC_PLL3DIVR_PLL3N|RCC_PLL3DIVR_PLL3P|RCC_PLL3DIVR_PLL3Q|RCC_PLL3DIVR_PLL3R),\
...
/**
  ...
  * @retval None
  */
#define  __HAL_RCC_PLL3FRACN_CONFIG(__PLL3FRACN__) MV_MODIFY_REG(RCC->PLL3FRACR, RCC_PLL3FRACR_PLL3FRACN, \
...
#define __HAL_RCC_PLL3_VCIRANGE(__PLL3VCIRange__) \
  MV_MODIFY_REG(RCC->PLL3CFGR, RCC_PLL3CFGR_PLL3RGE, (__PLL3VCIRange__))
...
/**
  ...
  * @retval None
  */
#define __HAL_RCC_PLL3FRACN_ENABLE()   MV_SET_BIT(RCC->PLL3CFGR, RCC_PLL3CFGR_PLL3FRACEN)
#define __HAL_RCC_PLL3FRACN_DISABLE()  MV_CLEAR_BIT(RCC->PLL3CFGR, RCC_PLL3CFGR_PLL3FRACEN)
...
/**
  ...
  * @retval None
  */
#define __HAL_RCC_PLL3CLKOUT_ENABLE(__PLL3_CLOCKOUT__)  MV_SET_BIT(RCC->PLL3CFGR, (__PLL3_CLOCKOUT__))
#define __HAL_RCC_PLL3CLKOUT_DISABLE(__PLL3_CLOCKOUT__) MV_CLEAR_BIT(RCC->PLL3CFGR, (__PLL3_CLOCKOUT__))
...
/**
  ...
  * @retval SET / RESET
  */
#define __HAL_RCC_GET_PLL3CLKOUT_CONFIG(__PLL3_CLOCKOUT__)  MV_READ_BIT(RCC->PLL3CFGR, (__PLL3_CLOCKOUT__))
...
#define __HAL_RCC_ADCDAC_CONFIG(__ADCDAC_CLKSOURCE__) \
  MV_MODIFY_REG(RCC->CCIPR3, RCC_CCIPR3_ADCDACSEL, (uint32_t)(__ADCDAC_CLKSOURCE__))
...
/** @brief  Macro to get the ADCDAC clock source.
  ...
  */
#define __HAL_RCC_GET_ADCDAC_SOURCE() ((uint32_t)(MV_READ_BIT(RCC->CCIPR3, RCC_CCIPR3_ADCDACSEL)))
...
#define __HAL_RCC_CLK48_CONFIG(__CLK48_SOURCE__) \
  MV_MODIFY_REG(RCC->CCIPR1, RCC_CCIPR1_ICLKSEL, (uint32_t)(__CLK48_SOURCE__))
...
/** @brief  macro to get the CLK48 source.
  ...
  */
#define __HAL_RCC_GET_ICLK_SOURCE() ((uint32_t)(MV_READ_BIT(RCC->CCIPR1, RCC_CCIPR1_ICLKSEL)))
...
#define __HAL_RCC_FDCAN1_CONFIG(__FDCAN1_CLKSOURCE__) \
  MV_MODIFY_REG(RCC->CCIPR1, RCC_CCIPR1_FDCANSEL, (uint32_t)(__FDCAN1_CLKSOURCE__))
...
/** @brief  Macro to get the FDCAN1 clock source.
  ...
  *            @arg @ref RCC_FDCAN1CLKSOURCE_PLL2  PLL2 Clock selected as FDCAN1 kernel clock
  */
#define __HAL_RCC_GET_FDCAN1_SOURCE() ((uint32_t)(MV_READ_BIT(RCC->CCIPR1, RCC_CCIPR1_FDCANSEL)))
...
#define __HAL_RCC_LPTIM34_CONFIG(__LPTIM34_CLKSOURCE__) \
  MV_MODIFY_REG(RCC->CCIPR3, RCC_CCIPR3_LPTIM34SEL, (uint32_t)(__LPTIM34_CLKSOURCE__))
...
/** @brief  Macro to get the LPTIM34 clock source.
  ...
  *            @arg @ref RCC_LPTIM34CLKSOURCE_LSE  LSE selected as LPTIM34 clock
  */
#define __HAL_RCC_GET_LPTIM34_SOURCE() ((uint32_t)(MV_READ_BIT(RCC->CCIPR3, RCC_CCIPR3_LPTIM34SEL)))
...
#define __HAL_RCC_LPTIM1_CONFIG(__LPTIM1_CLKSOURCE__) \
  MV_MODIFY_REG(RCC->CCIPR3, RCC_CCIPR3_LPTIM1SEL, (uint32_t)(__LPTIM1_CLKSOURCE__))
...
/** @brief  Macro to get the LPTIM1 clock source.
  ...
  *            @arg @ref RCC_LPTIM1CLKSOURCE_LSE  LSE selected as LPTIM1 clock
  */
#define __HAL_RCC_GET_LPTIM1_SOURCE() ((uint32_t)(MV_READ_BIT(RCC->CCIPR3, RCC_CCIPR3_LPTIM1SEL)))
...
#define __HAL_RCC_LPTIM2_CONFIG(__LPTIM2_CLKSOURCE__) \
  MV_MODIFY_REG(RCC->CCIPR1, RCC_CCIPR1_LPTIM2SEL, (uint32_t)(__LPTIM2_CLKSOURCE__))
...
/** @brief  Macro to get the LPTIM2 clock source.
  ...
  *            @arg @ref RCC_LPTIM2CLKSOURCE_LSE  LSE selected as LPTIM2 clock
  */
#define __HAL_RCC_GET_LPTIM2_SOURCE() ((uint32_t)(MV_READ_BIT(RCC->CCIPR1, RCC_CCIPR1_LPTIM2SEL)))
...
#define __HAL_RCC_SPI1_CONFIG(__SPI1CLKSource__) \
  MV_MODIFY_REG(RCC->CCIPR1, RCC_CCIPR1_SPI1SEL, (uint32_t)(__SPI1CLKSource__))
...
/** @brief  macro to get the SPI1 clock source.
  ...
  */
#define __HAL_RCC_GET_SPI1_SOURCE() ((uint32_t)(MV_READ_BIT(RCC->CCIPR1, RCC_CCIPR1_SPI1SEL)))
...
#define __HAL_RCC_SPI2_CONFIG(__SPI2CLKSource__) \
  MV_MODIFY_REG(RCC->CCIPR1, RCC_CCIPR1_SPI2SEL, (uint32_t)(__SPI2CLKSource__))
...
/** @brief  macro to get the SPI2 clock source.
  ...
  */
#define __HAL_RCC_GET_SPI2_SOURCE() ((uint32_t)(MV_READ_BIT(RCC->CCIPR1, RCC_CCIPR1_SPI2SEL)))
...
#define __HAL_RCC_SPI3_CONFIG(__SPI3CLKSource__) \
  MV_MODIFY_REG(RCC->CCIPR3, RCC_CCIPR3_SPI3SEL, (uint32_t)(__SPI3CLKSource__))
...
/** @brief  macro to get the SPI3 clock source.
  ...
  */
#define __HAL_RCC_GET_SPI3_SOURCE() ((uint32_t)(MV_READ_BIT(RCC->CCIPR3, RCC_CCIPR3_SPI3SEL)))
...
#define __HAL_RCC_I2C1_CONFIG(__I2C1_CLKSOURCE__) \
  MV_MODIFY_REG(RCC->CCIPR1, RCC_CCIPR1_I2C1SEL, (uint32_t)(__I2C1_CLKSOURCE__))
...
/** @brief  Macro to get the I2C1 clock source.
  ...
  *            @arg @ref RCC_I2C1CLKSOURCE_MSIK  MSIK selected as I2C1 clock
  */
#define __HAL_RCC_GET_I2C1_SOURCE() ((uint32_t)(MV_READ_BIT(RCC->CCIPR1, RCC_CCIPR1_I2C1SEL)))
...
#define __HAL_RCC_I2C2_CONFIG(__I2C2_CLKSOURCE__) \
  MV_MODIFY_REG(RCC->CCIPR1, RCC_CCIPR1_I2C2SEL, (uint32_t)(__I2C2_CLKSOURCE__))
...
/** @brief  Macro to get the I2C2 clock source.
  ...
  *            @arg @ref RCC_I2C2CLKSOURCE_MSIK  MSIK selected as I2C2 clock
  */
#define __HAL_RCC_GET_I2C2_SOURCE() ((uint32_t)(MV_READ_BIT(RCC->CCIPR1, RCC_CCIPR1_I2C2SEL)))
...
#define __HAL_RCC_I2C3_CONFIG(__I2C3_CLKSOURCE__) \
  MV_MODIFY_REG(RCC->CCIPR3, RCC_CCIPR3_I2C3SEL, (uint32_t)(__I2C3_CLKSOURCE__))
...
/** @brief  Macro to get the I2C3 clock source.
  ...
  */
#define __HAL_RCC_GET_I2C3_SOURCE() ((uint32_t)(MV_READ_BIT(RCC->CCIPR3, RCC_CCIPR3_I2C3SEL)))
...
#define __HAL_RCC_I2C4_CONFIG(__I2C4_CLKSOURCE__) \
  MV_MODIFY_REG(RCC->CCIPR1, RCC_CCIPR1_I2C4SEL, (uint32_t)(__I2C4_CLKSOURCE__))
...
/** @brief  Macro to get the I2C4 clock source.
  ...
  *            @arg @ref RCC_I2C4CLKSOURCE_MSIK  MSIK selected as I2C4 clock
  */
#define __HAL_RCC_GET_I2C4_SOURCE() ((uint32_t)(MV_READ_BIT(RCC->CCIPR1, RCC_CCIPR1_I2C4SEL)))
...
#define __HAL_RCC_I2C5_CONFIG(__I2C5_CLKSOURCE__) \
  MV_MODIFY_REG(RCC->CCIPR2, RCC_CCIPR2_I2C5SEL, (uint32_t)(__I2C5_CLKSOURCE__))
...
/** @brief  Macro to get the I2C5 clock source.
  ...
  *            @arg @ref RCC_I2C5CLKSOURCE_MSIK  MSIK selected as I2C5 clock
  */
#define __HAL_RCC_GET_I2C5_SOURCE() ((uint32_t)(MV_READ_BIT(RCC->CCIPR2, RCC_CCIPR2_I2C5SEL)))
#endif /* I2C5 */
...
#define __HAL_RCC_I2C6_CONFIG(__I2C6_CLKSOURCE__) \
  MV_MODIFY_REG(RCC->CCIPR2, RCC_CCIPR2_I2C6SEL, (uint32_t)(__I2C6_CLKSOURCE__))
...
/** @brief  Macro to get the I2C6 clock source.
  ...
  *            @arg @ref RCC_I2C6CLKSOURCE_MSIK  MSIK selected as I2C6 clock
  */
#define __HAL_RCC_GET_I2C6_SOURCE() ((uint32_t)(MV_READ_BIT(RCC->CCIPR2, RCC_CCIPR2_I2C6SEL)))
#endif /* I2C6 */
...
#define __HAL_RCC_USART1_CONFIG(__USART1_CLKSOURCE__) \
  MV_MODIFY_REG(RCC->CCIPR1, RCC_CCIPR1_USART1SEL, (uint32_t)(__USART1_CLKSOURCE__))
...
/** @brief  Macro to get the USART1 clock source.
  ...
  */
#define __HAL_RCC_GET_USART1_SOURCE() ((uint32_t)(MV_READ_BIT(RCC->CCIPR1, RCC_CCIPR1_USART1SEL)))
...
#define __HAL_RCC_USART2_CONFIG(__USART2_CLKSOURCE__) \
  MV_MODIFY_REG(RCC->CCIPR1, RCC_CCIPR1_USART2SEL, (uint32_t)(__USART2_CLKSOURCE__))
...
/** @brief  Macro to get the USART2 clock source.
  ...
  *            @arg @ref RCC_USART2CLKSOURCE_LSE  LSE selected as USART2 clock
  */
#define __HAL_RCC_GET_USART2_SOURCE() ((uint32_t)(MV_READ_BIT(RCC->CCIPR1, RCC_CCIPR1_USART2SEL)))
...
#define __HAL_RCC_USART3_CONFIG(__USART3_CLKSOURCE__) \
  MV_MODIFY_REG(RCC->CCIPR1, RCC_CCIPR1_USART3SEL, (uint32_t)(__USART3_CLKSOURCE__))
...
/** @brief  Macro to get the USART3 clock source.
  ...
  *            @arg @ref RCC_USART3CLKSOURCE_LSE  LSE selected as USART3 clock
  */
#define __HAL_RCC_GET_USART3_SOURCE() ((uint32_t)(MV_READ_BIT(RCC->CCIPR1, RCC_CCIPR1_USART3SEL)))
...
#define __HAL_RCC_UART4_CONFIG(__UART4_CLKSOURCE__) \
  MV_MODIFY_REG(RCC->CCIPR1, RCC_CCIPR1_UART4SEL, (uint32_t)(__UART4_CLKSOURCE__))
...
/** @brief  Macro to get the UART4 clock source.
  ...
  *            @arg @ref RCC_UART4CLKSOURCE_LSE  LSE selected as UART4 clock
  */
#define __HAL_RCC_GET_UART4_SOURCE() ((uint32_t)(MV_READ_BIT(RCC->CCIPR1, RCC_CCIPR1_UART4SEL)))
...
#define __HAL_RCC_UART5_CONFIG(__UART5_CLKSOURCE__) \
  MV_MODIFY_REG(RCC->CCIPR1, RCC_CCIPR1_UART5SEL, (uint32_t)(__UART5_CLKSOURCE__))
...
/** @brief  Macro to get the UART5 clock source.
  ...
  *            @arg @ref RCC_UART5CLKSOURCE_LSE  LSE selected as UART5 clock
  */
#define __HAL_RCC_GET_UART5_SOURCE() ((uint32_t)(MV_READ_BIT(RCC->CCIPR1, RCC_CCIPR1_UART5SEL)))
...
#define __HAL_RCC_USART6_CONFIG(__USART6_CLKSOURCE__) \
  MV_MODIFY_REG(RCC->CCIPR2, RCC_CCIPR2_USART6SEL, (uint32_t)(__USART6_CLKSOURCE__))
...
/** @brief  Macro to get the USART6 clock source.
  ...
  *            @arg @ref RCC_USART6CLKSOURCE_LSE  LSE selected as USART6 clock
  */
#define __HAL_RCC_GET_USART6_SOURCE() ((uint32_t)(MV_READ_BIT(RCC->CCIPR2, RCC_CCIPR2_USART6SEL)))
#endif /* USART6 */
...
#define __HAL_RCC_LPUART1_CONFIG(__LPUART1_CLKSOURCE__) \
  MV_MODIFY_REG(RCC->CCIPR3, RCC_CCIPR3_LPUART1SEL, (uint32_t)(__LPUART1_CLKSOURCE__))
...
/** @brief  Macro to get the LPUART1 clock source.
  ...
  *            @arg @ref RCC_LPUART1CLKSOURCE_LSE  LSE selected as LPUART1 clock
  */
#define __HAL_RCC_GET_LPUART1_SOURCE() ((uint32_t)(MV_READ_BIT(RCC->CCIPR3, RCC_CCIPR3_LPUART1SEL)))
...
#define __HAL_RCC_OSPI_CONFIG(__OSPI_CLKSOURCE__) \
  MV_MODIFY_REG(RCC->CCIPR2, RCC_CCIPR2_OCTOSPISEL, (uint32_t)(__OSPI_CLKSOURCE__))
...
/** @brief  Macro to get the OctoSPI clock source.
  ...
  *            @arg @ref RCC_OSPICLKSOURCE_PLL2   PLL2 Q divider clock selected as OctoSPI clock
  */
#define __HAL_RCC_GET_OSPI_SOURCE() ((uint32_t)(MV_READ_BIT(RCC->CCIPR2, RCC_CCIPR2_OCTOSPISEL)))
...
#define __HAL_RCC_HSPI_CONFIG(__HSPI_CLKSOURCE__) \
  MV_MODIFY_REG(RCC->CCIPR2, RCC_CCIPR2_HSPISEL, (uint32_t)(__HSPI_CLKSOURCE__))
...
/** @brief  Macro to get the HexaSPI clock source.
  ...
  *            @arg @ref RCC_HSPICLKSOURCE_PLL3   PLL3 R divider clock selected as HexaSPI clock
  */
#define __HAL_RCC_GET_HSPI_SOURCE() ((uint32_t)(MV_READ_BIT(RCC->CCIPR2, RCC_CCIPR2_HSPISEL)))
#endif /* HSPI1 */
...
#define __HAL_RCC_SDMMC_CONFIG(__SDMMC_CLKSOURCE__) \
  MV_MODIFY_REG(RCC->CCIPR2, RCC_CCIPR2_SDMMCSEL, (uint32_t)(__SDMMC_CLKSOURCE__))
...
/** @brief  macro to get the SDMMC1/2 clock source.
  ...
  *            @arg RCC_SDMMCCLKSOURCE_PLL1: PLL1 P selected as SDMMC1/2 clock
  */
#define __HAL_RCC_GET_SDMMC_SOURCE() ((uint32_t)(MV_READ_BIT(RCC->CCIPR2, RCC_CCIPR2_SDMMCSEL)))
...
#define __HAL_RCC_RNG_CONFIG(__RNG_CLKSource__) \
  MV_MODIFY_REG(RCC->CCIPR2, RCC_CCIPR2_RNGSEL, (uint32_t)(__RNG_CLKSource__))
...
/** @brief  macro to get the RNG clock source.
  ...
  *            @arg RCC_RNGCLKSOURCE_HSI: HSI selected as RNG clock
  */
#define __HAL_RCC_GET_RNG_SOURCE() ((uint32_t)(MV_READ_BIT(RCC->CCIPR2, RCC_CCIPR2_RNGSEL)))
...
#define __HAL_RCC_SAES_CONFIG(__SAES_CLKSource__) \
  MV_MODIFY_REG(RCC->CCIPR2, RCC_CCIPR2_SAESSEL, (uint32_t)(__SAES_CLKSource__))
...
/** @brief  macro to get the SAES clock source.
  ...
  *            @arg RCC_SAESCLKSOURCE_SHSI_DIV2: SHSI/2 selected as SAES clock
  */
#define __HAL_RCC_GET_SAES_SOURCE() ((uint32_t)(MV_READ_BIT(RCC->CCIPR2, RCC_CCIPR2_SAESSEL)))
...
#define __HAL_RCC_SAI1_CONFIG(__SAI1_CLKSOURCE__)\
  MV_MODIFY_REG(RCC->CCIPR2, RCC_CCIPR2_SAI1SEL, (uint32_t)(__SAI1_CLKSOURCE__))
...
/** @brief  Macro to get the SAI1 clock source.
  ...
  */
#define __HAL_RCC_GET_SAI1_SOURCE() ((uint32_t)(MV_READ_BIT(RCC->CCIPR2, RCC_CCIPR2_SAI1SEL)))
...
#define __HAL_RCC_SAI2_CONFIG(__SAI2_CLKSOURCE__ )\
  MV_MODIFY_REG(RCC->CCIPR2, RCC_CCIPR2_SAI2SEL, (uint32_t)(__SAI2_CLKSOURCE__))
...
/** @brief  Macro to get the SAI2 clock source.
  ...
  *             @arg @ref RCC_SAI2CLKSOURCE_HSI  SAI2 clock = HSI16
  */
#define __HAL_RCC_GET_SAI2_SOURCE() ((uint32_t)(MV_READ_BIT(RCC->CCIPR2, RCC_CCIPR2_SAI2SEL)))
...
#define __HAL_RCC_MDF1_CONFIG(__MDF1_CLKSOURCE__) \
  MV_MODIFY_REG(RCC->CCIPR2, RCC_CCIPR2_MDF1SEL, (uint32_t)(__MDF1_CLKSOURCE__))
...
/** @brief  Macro to get the MDF1 clock source.
  ...
  */
#define __HAL_RCC_GET_MDF1_SOURCE() ((uint32_t)(MV_READ_BIT(RCC->CCIPR2, RCC_CCIPR2_MDF1SEL)))
...
#define __HAL_RCC_ADF1_CONFIG(__ADF1_CLKSOURCE__) \
  MV_MODIFY_REG(RCC->CCIPR3, RCC_CCIPR3_ADF1SEL, (uint32_t)(__ADF1_CLKSOURCE__))
...
/** @brief  Macro to get the ADF1 clock source.
  ...
  */
#define __HAL_RCC_GET_ADF1_SOURCE() ((uint32_t)(MV_READ_BIT(RCC->CCIPR3, RCC_CCIPR3_ADF1SEL)))
...
#define __HAL_RCC_DAC1_CONFIG(__DAC1_CLKSOURCE__) \
  MV_MODIFY_REG(RCC->CCIPR3, RCC_CCIPR3_DAC1SEL, (uint32_t)(__DAC1_CLKSOURCE__))
...
/** @brief  Macro to get the DAC1 clock source.
  ...
  *            @arg @ref RCC_DAC1CLKSOURCE_LSI LSI clock selected as DAC1 clock
  */
#define __HAL_RCC_GET_DAC1_SOURCE() ((uint32_t)(MV_READ_BIT(RCC->CCIPR3, RCC_CCIPR3_DAC1SEL)))
...
#define __HAL_RCC_LTDC_CONFIG(__LTDC_CLKSOURCE__) \
  MV_MODIFY_REG(RCC->CCIPR2, RCC_CCIPR2_LTDCSEL, (__LTDC_CLKSOURCE__))
...
/** @brief  Macro to get the LTDC clock source.
  ...
  *            @arg @ref RCC_LTDCCLKSOURCE_PLL2   PLL2 divider R clock selected as LTDC kernel clock
  */
#define __HAL_RCC_GET_LTDC_SOURCE() (MV_READ_BIT(RCC->CCIPR2, RCC_CCIPR2_LTDCSEL))
...
#define __HAL_RCC_DSI_CONFIG(__DSI_CLKSOURCE__) \
  MV_MODIFY_REG(RCC->CCIPR2, RCC_CCIPR2_DSIHOSTSEL, (__DSI_CLKSOURCE__))
...
/** @brief  Macro to get the DSI clock source.
  ...
  *            @arg @ref RCC_DSICLKSOURCE_PLL3 PLL3 divider P clock selected as DSI clock  (low power case)
  */
#define __HAL_RCC_GET_DSI_SOURCE() (MV_READ_BIT(RCC->CCIPR2, RCC_CCIPR2_DSIHOSTSEL))
...
#define __HAL_RCC_USBPHY_CONFIG(__USBPHY_CLKSOURCE__) \
  MV_MODIFY_REG(RCC->CCIPR2, RCC_CCIPR2_USBPHYCSEL, (__USBPHY_CLKSOURCE__))
...
/** @brief  Macro to get the USB PHY clock source.
  ...
  *            @arg @ref RCC_USBPHYCLKSOURCE_PLL1_DIV2  PLL1 P divider clock div by 2 selected as USB PHY clock
  */
#define __HAL_RCC_GET_USBPHY_SOURCE() (MV_READ_BIT(RCC->CCIPR2, RCC_CCIPR2_USBPHYCSEL))
...
#define __HAL_RCC_DPHY_CONFIG(__PRESCALER__) \
  MV_MODIFY_REG(RCC->CFGR2, RCC_CFGR2_PPRE_DPHY, (__PRESCALER__) << 8UL)
...
/** @brief  Macro to get the DPHY clock prescaler configuration.
  ...
  * @retval None
  */
#define __HAL_RCC_GET_DPHY_CONFIG()  (MV_READ_BIT(RCC->CFGR2, RCC_CFGR2_PPRE_DPHY) >> 8UL)
...
/**
  ...
  * @retval None
  */
#define __HAL_RCC_CRS_ENABLE_IT(__INTERRUPT__)   MV_SET_BIT(CRS->CR, (__INTERRUPT__))
...
/**
  ...
  * @retval None
  */
#define __HAL_RCC_CRS_DISABLE_IT(__INTERRUPT__)  MV_CLEAR_BIT(CRS->CR, (__INTERRUPT__))
...
/** @brief  Check whether the CRS interrupt has occurred or not.
  ...
  */
#define __HAL_RCC_CRS_GET_IT_SOURCE(__INTERRUPT__)  ((MV_READ_BIT(CRS->CR, (__INTERRUPT__)) != RESET) ? SET : RESET)
...
#define __HAL_RCC_CRS_CLEAR_IT(__INTERRUPT__)  do { \
                                                    ...
                                                    { \
                                                      MV_WRITE_REG(CRS->ICR, (__INTERRUPT__)); \
                                                    } \
                                                  } while(0)
...
/**
  ...
  */
#define __HAL_RCC_CRS_GET_FLAG(__FLAG__)  (MV_READ_BIT(CRS->ISR, (__FLAG__)) == (__FLAG__))
...
/**
  ...
  * @retval None
  */
#define __HAL_RCC_CRS_FREQ_ERROR_COUNTER_ENABLE()  MV_SET_BIT(CRS->CR, CRS_CR_CEN)

/**
  * @brief  Disable the oscillator clock for frequency error counter.
  * @retval None
  */
#define __HAL_RCC_CRS_FREQ_ERROR_COUNTER_DISABLE() MV_CLEAR_BIT(CRS->CR, CRS_CR_CEN)
...
/**
  ...
  * @retval None
  */
#define __HAL_RCC_CRS_AUTOMATIC_CALIB_ENABLE()     MV_SET_BIT(CRS->CR, CRS_CR_AUTOTRIMEN)

/**
  * @brief  Enable or disable the automatic hardware adjustment of TRIM bits.
  * @retval None
  */
#define __HAL_RCC_CRS_AUTOMATIC_CALIB_DISABLE()    MV_CLEAR_BIT(CRS->CR, CRS_CR_AUTOTRIMEN)
