...
#define __HAL_RCC_CLK48_CONFIG(__CLK48_SOURCE__) \
  MV_MODIFY_REG(RCC->CCIPR1, RCC_CCIPR1_CLK48MSEL, (uint32_t)(__CLK48_SOURCE__))
...
/** @brief  macro to get the CLK48 source.
  ...
  */
#define __HAL_RCC_GET_CLK48_SOURCE() ((uint32_t)(MV_READ_BIT(RCC->CCIPR1, RCC_CCIPR1_CLK48MSEL)))
