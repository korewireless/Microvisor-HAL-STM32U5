...
/**
  ...
  */
#define __HAL_GPU2D_GET_FLAG(__HANDLE__, __FLAG__) (MV_READ_REG(*(__IO uint32_t *)((uint32_t)(__HANDLE__)->Instance\
...
/**
  ...
  */
#define __HAL_GPU2D_GET_IT_SOURCE(__HANDLE__, __INTERRUPT__) (MV_READ_REG(*(__IO uint32_t *)\
