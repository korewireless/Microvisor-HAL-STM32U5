...
typedef struct
{
  uint32_t ClkPort;                   /*!< It indicates which port of the XSPI IO Manager is used for the CLK pins.
                                           This parameter can be a value between 1 and 8 */
  uint32_t DQSPort;                   /*!< It indicates which port of the XSPI IO Manager is used for the DQS pin.
                                           This parameter can be a value between 1 and 8,
                                           0 means that signal not used */
  uint32_t NCSPort;                   /*!< It indicates which port of the XSPI IO Manager is used for the NCS pin.
                                           This parameter can be a value between 1 and 8 */
  uint32_t IOLowPort;                 /*!< It indicates which port of the XSPI IO Manager is used for the IO[3:0] pins.
                                           This parameter can be a value of @ref XSPIM_IOPort */
  uint32_t IOHighPort;                /*!< It indicates which port of the XSPI IO Manager is used for the IO[7:4] pins.
                                           This parameter can be a value of @ref XSPIM_IOPort */
...
#define HAL_XSPI_SELECT_IO_15_8              ((uint32_t)HSPI_CR_MSEL_1)                   /*!< Data exchanged over IO[15:8]  */
#else
...
#define HAL_XSPIM_IOPORT_1_LOW             ((uint32_t)(OCTOSPIM_PCR_IOLEN | 0x1U))  /*!< Port 1 - IO[3:0] */
#define HAL_XSPIM_IOPORT_1_HIGH            ((uint32_t)(OCTOSPIM_PCR_IOHEN | 0x1U))  /*!< Port 1 - IO[7:4] */
#define HAL_XSPIM_IOPORT_2_LOW             ((uint32_t)(OCTOSPIM_PCR_IOLEN | 0x2U))  /*!< Port 2 - IO[3:0] */
#define HAL_XSPIM_IOPORT_2_HIGH            ((uint32_t)(OCTOSPIM_PCR_IOHEN | 0x2U))  /*!< Port 2 - IO[7:4] */
#define HAL_XSPIM_IOPORT_3_LOW             ((uint32_t)(OCTOSPIM_PCR_IOLEN | 0x3U))  /*!< Port 3 - IO[3:0] */
#define HAL_XSPIM_IOPORT_3_HIGH            ((uint32_t)(OCTOSPIM_PCR_IOHEN | 0x3U))  /*!< Port 3 - IO[7:4] */
#define HAL_XSPIM_IOPORT_4_LOW             ((uint32_t)(OCTOSPIM_PCR_IOLEN | 0x4U))  /*!< Port 4 - IO[3:0] */
#define HAL_XSPIM_IOPORT_4_HIGH            ((uint32_t)(OCTOSPIM_PCR_IOHEN | 0x4U))  /*!< Port 4 - IO[7:4] */
#define HAL_XSPIM_IOPORT_5_LOW             ((uint32_t)(OCTOSPIM_PCR_IOLEN | 0x5U))  /*!< Port 5 - IO[3:0] */
#define HAL_XSPIM_IOPORT_5_HIGH            ((uint32_t)(OCTOSPIM_PCR_IOHEN | 0x5U))  /*!< Port 5 - IO[7:4] */
#define HAL_XSPIM_IOPORT_6_LOW             ((uint32_t)(OCTOSPIM_PCR_IOLEN | 0x6U))  /*!< Port 6 - IO[3:0] */
#define HAL_XSPIM_IOPORT_6_HIGH            ((uint32_t)(OCTOSPIM_PCR_IOHEN | 0x6U))  /*!< Port 6 - IO[7:4] */
#define HAL_XSPIM_IOPORT_7_LOW             ((uint32_t)(OCTOSPIM_PCR_IOLEN | 0x7U))  /*!< Port 7 - IO[3:0] */
...
/** @brief  Enable the XSPI peripheral.
  ...
  * @retval None
  */
#define HAL_XSPI_ENABLE(__HANDLE__)                       MV_SET_BIT((__HANDLE__)->Instance->CR, XSPI_CR_EN)

/** @brief  Disable the XSPI peripheral.
  * @param  __HANDLE__ specifies the XSPI Handle.
  * @retval None
  */
#define HAL_XSPI_DISABLE(__HANDLE__)                      MV_CLEAR_BIT((__HANDLE__)->Instance->CR, XSPI_CR_EN)
...
/** @brief  Enable the specified XSPI interrupt.
  ...
  * @retval None
  */
#define HAL_XSPI_ENABLE_IT(__HANDLE__, __INTERRUPT__)     MV_SET_BIT((__HANDLE__)->Instance->CR, (__INTERRUPT__))
...
/** @brief  Disable the specified XSPI interrupt.
  ...
  * @retval None
  */
#define HAL_XSPI_DISABLE_IT(__HANDLE__, __INTERRUPT__)    MV_CLEAR_BIT((__HANDLE__)->Instance->CR, (__INTERRUPT__))
...
/** @brief  Check whether the specified XSPI interrupt source is enabled or not.
  ...
  */
#define HAL_XSPI_GET_IT_SOURCE(__HANDLE__, __INTERRUPT__) (MV_READ_BIT((__HANDLE__)->Instance->CR, (__INTERRUPT__))\
                                                           == (__INTERRUPT__))
...
/**
  ...
  * @retval None
  */
#define HAL_XSPI_GET_FLAG(__HANDLE__, __FLAG__)           ((MV_READ_BIT((__HANDLE__)->Instance->SR, (__FLAG__)) \
                                                            != 0U) ? SET : RESET)
...
/** @brief  Clears the specified XSPI's flag status.
  ...
  * @retval None
  */
#define HAL_XSPI_CLEAR_FLAG(__HANDLE__, __FLAG__)         MV_WRITE_REG((__HANDLE__)->Instance->FCR, (__FLAG__))
...
#define IS_OCTOSPI_IO_SELECT(MEMSEL)              (((MEMSEL) == HAL_XSPI_SELECT_IO_3_0)   || \
...
#define IS_OCTOSPI_DATA_MODE(MODE)                (((MODE) == HAL_XSPI_DATA_NONE)    || \
...
#define IS_XSPIM_IO_PORT(PORT)                    (((PORT) == HAL_XSPIM_IOPORT_1_LOW)  || \
                                                   ((PORT) == HAL_XSPIM_IOPORT_1_HIGH) || \
                                                   ((PORT) == HAL_XSPIM_IOPORT_2_LOW)  || \
                                                   ((PORT) == HAL_XSPIM_IOPORT_2_HIGH) || \
                                                   ((PORT) == HAL_XSPIM_IOPORT_3_LOW)  || \
                                                   ((PORT) == HAL_XSPIM_IOPORT_3_HIGH) || \
                                                   ((PORT) == HAL_XSPIM_IOPORT_4_LOW)  || \
                                                   ((PORT) == HAL_XSPIM_IOPORT_4_HIGH) || \
                                                   ((PORT) == HAL_XSPIM_IOPORT_5_LOW)  || \
                                                   ((PORT) == HAL_XSPIM_IOPORT_5_HIGH) || \
                                                   ((PORT) == HAL_XSPIM_IOPORT_6_LOW)  || \
                                                   ((PORT) == HAL_XSPIM_IOPORT_6_HIGH) || \
                                                   ((PORT) == HAL_XSPIM_IOPORT_7_LOW)  || \
                                                   ((PORT) == HAL_XSPIM_IOPORT_7_HIGH) || \
                                                   ((PORT) == HAL_XSPIM_IOPORT_8_LOW)  || \
                                                   ((PORT) == HAL_XSPIM_IOPORT_8_HIGH))
