...
/**
  ...
  * @retval None
  */
#define LL_RCC_WriteReg(__REG__, __VALUE__) mvPeriphPoke32((uint32_t)&RCC->__REG__, 0xffffffff, (__VALUE__))
...
/**
  ...
  */
#define LL_RCC_ReadReg(__REG__) ReadRegisterOrZeroOnError((uint32_t)&RCC->__REG__)
/**
  * @}
  */
...
{
  MV_SET_BIT(RCC->CR, RCC_CR_CSSON);
}
...
{
  return ((MV_READ_BIT(RCC->CR, RCC_CR_HSERDY) == RCC_CR_HSERDY) ? 1UL : 0UL);
}
...
{
  MV_MODIFY_REG(RCC->CR, RCC_CR_HSEEXT, HSEMode);
}
...
{
  return (uint32_t)(MV_READ_BIT(RCC->CR, RCC_CR_HSEEXT));
}
...
{
  MV_SET_BIT(RCC->CR, RCC_CR_HSIKERON);
}
...
{
  MV_CLEAR_BIT(RCC->CR, RCC_CR_HSIKERON);
}
...
{
  return ((MV_READ_BIT(RCC->CR, RCC_CR_HSIKERON) == RCC_CR_HSIKERON) ? 1UL : 0UL);
}
...
{
  MV_SET_BIT(RCC->CR, RCC_CR_HSION);
}
...
{
  MV_CLEAR_BIT(RCC->CR, RCC_CR_HSION);
}
...
{
  return ((MV_READ_BIT(RCC->CR, RCC_CR_HSIRDY) == RCC_CR_HSIRDY) ? 1UL : 0UL);
}
...
{
  return (uint32_t)(MV_READ_BIT(RCC->ICSCR3, RCC_ICSCR3_HSICAL) >> RCC_ICSCR3_HSICAL_Pos);
}
...
{
  MV_MODIFY_REG(RCC->ICSCR3, RCC_ICSCR3_HSITRIM, Value << RCC_ICSCR3_HSITRIM_Pos);
}
...
{
  return (uint32_t)(MV_READ_BIT(RCC->ICSCR3, RCC_ICSCR3_HSITRIM) >> RCC_ICSCR3_HSITRIM_Pos);
}
...
{
  MV_SET_BIT(RCC->CR, RCC_CR_HSI48ON);
}
...
{
  MV_CLEAR_BIT(RCC->CR, RCC_CR_HSI48ON);
}
...
{
  return ((MV_READ_BIT(RCC->CR, RCC_CR_HSI48RDY) == RCC_CR_HSI48RDY) ? 1UL : 0UL);
}
...
{
  return (uint32_t)(MV_READ_BIT(RCC->CRRCR, RCC_CRRCR_HSI48CAL) >> RCC_CRRCR_HSI48CAL_Pos);
}
...
{
  MV_MODIFY_REG(RCC->BDCR, RCC_BDCR_LSEDRV, LSEDrive);
}
...
{
  return (uint32_t)(MV_READ_BIT(RCC->BDCR, RCC_BDCR_LSEDRV));
}
...
{
  return ((MV_READ_BIT(RCC->BDCR, RCC_BDCR_LSERDY) == RCC_BDCR_LSERDY) ? 1UL : 0UL);
}
...
{
  MV_SET_BIT(RCC->BDCR, RCC_BDCR_LSESYSEN);
}
...
{
  return ((MV_READ_BIT(RCC->BDCR, RCC_BDCR_LSESYSRDY) == RCC_BDCR_LSESYSRDY) ? 1UL : 0UL);
}
...
{
  MV_CLEAR_BIT(RCC->BDCR, RCC_BDCR_LSESYSEN);
}
...
{
  return ((MV_READ_BIT(RCC->BDCR, RCC_BDCR_LSECSSD) == RCC_BDCR_LSECSSD) ? 1UL : 0UL);
}
...
{
  MV_SET_BIT(RCC->BDCR, RCC_BDCR_LSION);
}
...
{
  MV_CLEAR_BIT(RCC->BDCR, RCC_BDCR_LSION);
}
...
{
  return ((MV_READ_BIT(RCC->BDCR, RCC_BDCR_LSIRDY) == RCC_BDCR_LSIRDY) ? 1UL : 0UL);
}
...
{
  MV_MODIFY_REG(RCC->BDCR, RCC_BDCR_LSIPREDIV, LSIPrescaler);
}
...
{
  return (MV_READ_BIT(RCC->BDCR, RCC_BDCR_LSIPREDIV));
}
...
{
  MV_SET_BIT(RCC->CR, RCC_CR_MSIKON);
}
...
{
  MV_CLEAR_BIT(RCC->CR, RCC_CR_MSIKON);
}
...
{
  return ((MV_READ_BIT(RCC->CR, RCC_CR_MSIKRDY) == RCC_CR_MSIKRDY) ? 1UL : 0UL);
}
...
{
  MV_SET_BIT(RCC->CR, RCC_CR_SHSION);
}
...
{
  MV_CLEAR_BIT(RCC->CR, RCC_CR_SHSION);
}
...
{
  return ((MV_READ_BIT(RCC->CR, RCC_CR_SHSIRDY) == RCC_CR_SHSIRDY) ? 1UL : 0UL);
}
/**
  * @}
  */
...
{
  MV_SET_BIT(RCC->CR, RCC_CR_MSISON);
}
...
{
  MV_CLEAR_BIT(RCC->CR, RCC_CR_MSISON);
}
...
{
  return ((MV_READ_BIT(RCC->CR, RCC_CR_MSISRDY) == RCC_CR_MSISRDY) ? 1UL : 0UL);
}
...
{
  MV_MODIFY_REG(RCC->CR, RCC_CR_MSIPLLSEL, Source);
}
...
{
  return (uint32_t)(MV_READ_BIT(RCC->CR, RCC_CR_MSIPLLSEL));
}
...
{
  return ((MV_READ_BIT(RCC->CR, RCC_CR_MSIPLLFAST) == RCC_CR_MSIPLLFAST) ? 1UL : 0UL);
}
...
{
  MV_MODIFY_REG(RCC->ICSCR1, RCC_ICSCR1_MSIBIAS, BiasMode);
}
...
{
  return (uint32_t)(MV_READ_BIT(RCC->ICSCR1, RCC_ICSCR1_MSIBIAS));
}
...
{
  MV_SET_BIT(RCC->CR, RCC_CR_MSIKERON);
}
...
{
  MV_CLEAR_BIT(RCC->CR, RCC_CR_MSIKERON);
}
...
{
  return ((MV_READ_BIT(RCC->CR, RCC_CR_MSIKERON) == RCC_CR_MSIKERON) ? 1UL : 0UL);
}
...
{
  return ((MV_READ_BIT(RCC->ICSCR1, RCC_ICSCR1_MSIRGSEL) == RCC_ICSCR1_MSIRGSEL) ? 1UL : 0UL);
}
...
{
  MV_MODIFY_REG(RCC->ICSCR1, RCC_ICSCR1_MSISRANGE, Range);
}
...
{
  return (uint32_t)(MV_READ_BIT(RCC->ICSCR1, RCC_ICSCR1_MSISRANGE));
}
...
{
  MV_MODIFY_REG(RCC->CSR, RCC_CSR_MSISSRANGE, Range);
}
...
{
  return (uint32_t)(MV_READ_BIT(RCC->CSR, RCC_CSR_MSISSRANGE));
}
...
{
  MV_MODIFY_REG(RCC->ICSCR2, (RCC_ICSCR2_MSITRIM0  >> Oscillator), Value << (RCC_ICSCR2_MSITRIM0_Pos - Oscillator));
}
...
{
  return (uint32_t)(MV_READ_BIT(RCC->ICSCR2,
...
{
  return (uint32_t)(MV_READ_BIT(RCC->ICSCR1, (RCC_ICSCR1_MSICAL0 >> Oscillator)) >> (RCC_ICSCR1_MSICAL0_Pos - Oscillator));
}
...
{
  MV_MODIFY_REG(RCC->ICSCR1, RCC_ICSCR1_MSIKRANGE, Range);
}
...
{
  return (uint32_t)(MV_READ_BIT(RCC->ICSCR1, RCC_ICSCR1_MSIKRANGE));
}
...
{
  MV_MODIFY_REG(RCC->CSR, RCC_CSR_MSIKSRANGE, Range);
}
...
{
  return (uint32_t)(MV_READ_BIT(RCC->CSR, RCC_CSR_MSIKSRANGE));
}
/**
  * @}
  */
...
{
  MV_SET_BIT(RCC->BDCR, RCC_BDCR_LSCOEN);
}
...
{
  MV_MODIFY_REG(RCC->BDCR, RCC_BDCR_LSCOSEL, Source);
}
...
{
  return (uint32_t)(MV_READ_BIT(RCC->BDCR, RCC_BDCR_LSCOSEL));
}
...
{
  MV_MODIFY_REG(RCC->CFGR1, RCC_CFGR1_SW, Source);
}
...
{
  return (uint32_t)(MV_READ_BIT(RCC->CFGR1, RCC_CFGR1_SWS));
}
...
{
  MV_MODIFY_REG(RCC->CFGR2, RCC_CFGR2_HPRE, Prescaler);
}
...
{
  MV_MODIFY_REG(RCC->CCIPR1, RCC_CCIPR1_SYSTICKSEL, SystickSource);
}
...
{
  MV_MODIFY_REG(RCC->CFGR2, RCC_CFGR2_PPRE1, Prescaler);
}
...
{
  MV_MODIFY_REG(RCC->CFGR2, RCC_CFGR2_PPRE2, Prescaler);
}
...
{
  MV_MODIFY_REG(RCC->CFGR3, RCC_CFGR3_PPRE3, Prescaler);
}
...
{
  return (uint32_t)(MV_READ_BIT(RCC->CFGR2, RCC_CFGR2_HPRE));
}
...
{
  return (uint32_t)(MV_READ_BIT(RCC->CCIPR1, RCC_CCIPR1_SYSTICKSEL));
}
...
{
  return (uint32_t)(MV_READ_BIT(RCC->CFGR2, RCC_CFGR2_PPRE1));
}
...
{
  return (uint32_t)(MV_READ_BIT(RCC->CFGR2, RCC_CFGR2_PPRE2));
}
...
{
  return (uint32_t)(MV_READ_BIT(RCC->CFGR3, RCC_CFGR3_PPRE3));
}
...
{
  MV_MODIFY_REG(RCC->CFGR1, RCC_CFGR1_STOPWUCK, Clock);
}
...
{
  return (uint32_t)(MV_READ_BIT(RCC->CFGR1, RCC_CFGR1_STOPWUCK));
}
/**
  * @}
  */
...
{
  MV_MODIFY_REG(RCC->CFGR1, RCC_CFGR1_MCOSEL | RCC_CFGR1_MCOPRE, MCOxSource | MCOxPrescaler);
}
...
{
  MV_MODIFY_REG(RCC->CCIPR1, UARTxSource >> 16U, (UARTxSource & 0x0000FFFFU));
}
...
{
  MV_MODIFY_REG(RCC->CCIPR3, RCC_CCIPR3_LPUART1SEL, LPUARTxSource);
}
...
__STATIC_INLINE void LL_RCC_SetI2CClockSource(uint32_t I2CxSource)
{
  ...
  MV_MODIFY_REG(*reg, 3U << (((I2CxSource & 0x00FF0000U) >> 16U) & 0x1FU), ((I2CxSource & 0x000000FFU) << \
...
__STATIC_INLINE void LL_RCC_SetSPIClockSource(uint32_t SPIxSource)
{
  ...
  MV_MODIFY_REG(*reg, 3U << (((SPIxSource & 0x00FF0000U) >> 16U) & 0x1FU), ((SPIxSource & 0x000000FFU) << \
...
__STATIC_INLINE void LL_RCC_SetLPTIMClockSource(uint32_t LPTIMxSource)
{
  ...
  MV_MODIFY_REG(*reg, 3U << (((LPTIMxSource & 0x00FF0000U) >> 16U) & 0x1FU), ((LPTIMxSource & 0x000000FFU) << \
...
{
  MV_MODIFY_REG(RCC->CCIPR1, RCC_CCIPR1_FDCANSEL, FDCANxSource);
}
...
{
  MV_MODIFY_REG(RCC->CCIPR2, (SAIxSource >> 16U), (SAIxSource & 0x0000FFFFU));
}
...
{
  MV_MODIFY_REG(RCC->CCIPR2, RCC_CCIPR2_SDMMCSEL, SDMMCxSource);
}
...
{
  MV_MODIFY_REG(RCC->CCIPR1, RCC_CCIPR1_ICLKSEL, SDMMCxSource);
}
...
{
  MV_MODIFY_REG(RCC->CCIPR2, RCC_CCIPR2_RNGSEL, RNGxSource);
}
...
{
  MV_MODIFY_REG(RCC->CCIPR2, RCC_CCIPR2_USBPHYCSEL, Source);
}
#endif /* RCC_CCIPR2_USBPHYCSEL */
...
{
  MV_MODIFY_REG(RCC->CCIPR1, RCC_CCIPR1_ICLKSEL, USBxSource);
}
...
{
  MV_MODIFY_REG(RCC->CCIPR3, RCC_CCIPR3_ADCDACSEL, ADCxDAC1Source);
}
...
{
  MV_MODIFY_REG(RCC->CCIPR3, RCC_CCIPR3_DAC1SEL, Source);
}
...
{
  MV_MODIFY_REG(RCC->CCIPR3, RCC_CCIPR3_ADF1SEL, Source);
}
...
{
  MV_MODIFY_REG(RCC->CCIPR2, RCC_CCIPR2_MDF1SEL, Source);
}
...
{
  MV_MODIFY_REG(RCC->CCIPR2, RCC_CCIPR2_OCTOSPISEL, Source);
}
...
{
  MV_MODIFY_REG(RCC->CCIPR2, RCC_CCIPR2_HSPISEL, Source);
}
#endif /* HSPI1 */
/**
...
{
  MV_MODIFY_REG(RCC->CCIPR2, RCC_CCIPR2_SAESSEL, Source);
}
...
{
  MV_MODIFY_REG(RCC->CCIPR2, RCC_CCIPR2_DSIHOSTSEL, Source);
}
#endif /* DSI */
...
{
  MV_MODIFY_REG(RCC->CCIPR2, RCC_CCIPR2_LTDCSEL, Source);
}
#endif /* LTDC */
/**
...
{
  return (uint32_t)(MV_READ_BIT(RCC->CCIPR1, UARTx) | (UARTx << 16U));
}
...
{
  return (uint32_t)(MV_READ_BIT(RCC->CCIPR3, LPUARTx));
}
...
__STATIC_INLINE uint32_t LL_RCC_GetI2CClockSource(uint32_t I2Cx)
{
  ...
  return (uint32_t)((MV_READ_BIT(*reg, (3UL << (((I2Cx & 0x00FF0000UL) >> 16U) & 0x1FUL))) >> \
...
__STATIC_INLINE uint32_t LL_RCC_GetSPIClockSource(uint32_t SPIx)
{
  ...
  return (uint32_t)((MV_READ_BIT(*reg, (3UL << (((SPIx & 0x00FF0000UL) >> 16U) & 0x1FUL))) >> \
...
__STATIC_INLINE uint32_t LL_RCC_GetLPTIMClockSource(uint32_t LPTIMx)
{
  ...
  return (uint32_t)((MV_READ_BIT(*reg, (3UL << (((LPTIMx & 0x00FF0000UL) >> 16U) & 0x1FUL))) >> \
...
{
  MV_MODIFY_REG(RCC->CCIPR1, RCC_CCIPR1_TIMICSEL, TIMICSource);
}
...
{
  return (uint32_t)(MV_READ_BIT(RCC->CCIPR1, RCC_CCIPR1_TIMICSEL));
}
...
{
  return (uint32_t)(MV_READ_BIT(RCC->CCIPR1, FDCANx));
}
...
{
  return (uint32_t)(MV_READ_BIT(RCC->CCIPR2, SAIx) | (SAIx << 16U));
}
...
{
  return (uint32_t)(MV_READ_BIT(RCC->CCIPR2, SDMMCx));
}
...
{
  return (uint32_t)(MV_READ_BIT(RCC->CCIPR1, SDMMCx));
}
...
{
  return (uint32_t)(MV_READ_BIT(RCC->CCIPR2, RNGx));
}
...
{
  return (uint32_t)(MV_READ_BIT(RCC->CCIPR1, USBx));
}
...
{
  return (uint32_t)(MV_READ_BIT(RCC->CCIPR3, ADCxDAC1));
}
...
{
  return (uint32_t)(MV_READ_BIT(RCC->CCIPR3, ADF1x));
}
...
{
  return (uint32_t)(MV_READ_BIT(RCC->CCIPR3, DAC1x));
}
...
{
  return (uint32_t)(MV_READ_BIT(RCC->CCIPR2, MDF1x));
}
...
{
  return (uint32_t)(MV_READ_BIT(RCC->CCIPR2, OCTOSPIx));
}
...
{
  return (uint32_t)(MV_READ_BIT(RCC->CCIPR2, HSPIx));
}
#endif /* HSPI1 */
/**
  * @}
...
{
  return (uint32_t)(MV_READ_BIT(RCC->CCIPR2, SAESx));
}
...
{
  return (uint32_t)(MV_READ_BIT(RCC->CCIPR2, DSIx));
}
#endif /* DSI */
...
{
  return (uint32_t)(MV_READ_BIT(RCC->CCIPR2, LTDCx));
}
#endif /* LTDC */
...
{
  MV_MODIFY_REG(RCC->BDCR, RCC_BDCR_RTCSEL, Source);
}
...
{
  return (uint32_t)(MV_READ_BIT(RCC->BDCR, RCC_BDCR_RTCSEL));
}
...
{
  MV_SET_BIT(RCC->BDCR, RCC_BDCR_RTCEN);
}
...
{
  MV_CLEAR_BIT(RCC->BDCR, RCC_BDCR_RTCEN);
}
...
{
  return ((MV_READ_BIT(RCC->BDCR, RCC_BDCR_RTCEN) == RCC_BDCR_RTCEN) ? 1UL : 0UL);
}
...
{
  MV_SET_BIT(RCC->BDCR, RCC_BDCR_BDRST);
}
...
{
  MV_CLEAR_BIT(RCC->BDCR, RCC_BDCR_BDRST);
}
...
{
  MV_SET_BIT(RCC->CR, RCC_CR_PLL1ON);
}
...
{
  MV_CLEAR_BIT(RCC->CR, RCC_CR_PLL1ON);
}
...
{
  return ((MV_READ_BIT(RCC->CR, RCC_CR_PLL1RDY) == RCC_CR_PLL1RDY) ? 1UL : 0UL);
}
...
{
  MV_MODIFY_REG(RCC->PLL1CFGR, RCC_PLL1CFGR_PLL1SRC | RCC_PLL1CFGR_PLL1M, Source | \
             ((PLLM - 1UL) << RCC_PLL1CFGR_PLL1M_Pos));
  MV_MODIFY_REG(RCC->PLL1DIVR, RCC_PLL1DIVR_PLL1N | RCC_PLL1DIVR_PLL1R, ((PLLN - 1UL) << \
...
__STATIC_INLINE void LL_RCC_PLL1_ConfigDomain_SAI(uint32_t Source, uint32_t PLLM, uint32_t PLLN, uint32_t PLLP)
{
  MV_MODIFY_REG(RCC->PLL1CFGR, RCC_PLL1CFGR_PLL1SRC | RCC_PLL1CFGR_PLL1M, Source | \
             ((PLLM - 1UL) << RCC_PLL1CFGR_PLL1M_Pos));
  MV_MODIFY_REG(RCC->PLL1DIVR, RCC_PLL1DIVR_PLL1N | RCC_PLL1DIVR_PLL1P, ((PLLN - 1UL) << \
...
__STATIC_INLINE void LL_RCC_PLL1_ConfigDomain_48M(uint32_t Source, uint32_t PLLM, uint32_t PLLN, uint32_t PLLQ)
{
  MV_MODIFY_REG(RCC->PLL1CFGR, RCC_PLL1CFGR_PLL1SRC | RCC_PLL1CFGR_PLL1M, Source | \
             ((PLLM - 1UL) << RCC_PLL1CFGR_PLL1M_Pos));
  MV_MODIFY_REG(RCC->PLL1DIVR, RCC_PLL1DIVR_PLL1N | RCC_PLL1DIVR_PLL1Q, ((PLLN - 1UL) << \
...
{
  MV_MODIFY_REG(RCC->PLL1CFGR, RCC_PLL1CFGR_PLL1SRC, PLL1Source);
}
...
{
  return (uint32_t)(MV_READ_BIT(RCC->PLL1CFGR, RCC_PLL1CFGR_PLL1SRC));
}
...
{
  MV_MODIFY_REG(RCC->PLL1DIVR, RCC_PLL1DIVR_PLL1N, (PLL1N - 1UL) << RCC_PLL1DIVR_PLL1N_Pos);
}
...
{
  return (uint32_t)((MV_READ_BIT(RCC->PLL1DIVR, RCC_PLL1DIVR_PLL1N) >>  RCC_PLL1DIVR_PLL1N_Pos) + 1UL);
}
...
{
  MV_MODIFY_REG(RCC->PLL1DIVR, RCC_PLL1DIVR_PLL1P, (PLL1P - 1UL) << RCC_PLL1DIVR_PLL1P_Pos);
}
...
{
  return (uint32_t)((MV_READ_BIT(RCC->PLL1DIVR, RCC_PLL1DIVR_PLL1P) >>  RCC_PLL1DIVR_PLL1P_Pos) + 1UL);
}
...
{
  MV_MODIFY_REG(RCC->PLL1DIVR, RCC_PLL1DIVR_PLL1Q, (PLL1Q - 1UL) << RCC_PLL1DIVR_PLL1Q_Pos);
}
...
{
  return (uint32_t)((MV_READ_BIT(RCC->PLL1DIVR, RCC_PLL1DIVR_PLL1Q) >>  RCC_PLL1DIVR_PLL1Q_Pos) + 1UL);
}
...
{
  MV_MODIFY_REG(RCC->PLL1DIVR, RCC_PLL1DIVR_PLL1R, (PLL1R - 1UL) << RCC_PLL1DIVR_PLL1R_Pos);
}
...
{
  return (uint32_t)((MV_READ_BIT(RCC->PLL1DIVR, RCC_PLL1DIVR_PLL1R) >>  RCC_PLL1DIVR_PLL1R_Pos) + 1UL);
}
...
{
  MV_MODIFY_REG(RCC->PLL1CFGR, RCC_PLL1CFGR_PLL1M, (PLL1M - 1UL) << RCC_PLL1CFGR_PLL1M_Pos);
}
...
{
  return (uint32_t)((MV_READ_BIT(RCC->PLL1CFGR, RCC_PLL1CFGR_PLL1M) >>  RCC_PLL1CFGR_PLL1M_Pos) + 1UL);
}
...
{
  MV_SET_BIT(RCC->PLL1CFGR, RCC_PLL1CFGR_PLL1PEN);
}
...
{
  MV_CLEAR_BIT(RCC->PLL1CFGR, RCC_PLL1CFGR_PLL1PEN);
}
...
{
  return ((MV_READ_BIT(RCC->PLL1CFGR, RCC_PLL1CFGR_PLL1PEN) == (RCC_PLL1CFGR_PLL1PEN)) ? 1UL : 0UL);
}
...
{
  MV_SET_BIT(RCC->PLL1CFGR, RCC_PLL1CFGR_PLL1QEN);
}
...
{
  MV_CLEAR_BIT(RCC->PLL1CFGR, RCC_PLL1CFGR_PLL1QEN);
}
...
{
  return ((MV_READ_BIT(RCC->PLL1CFGR, RCC_PLL1CFGR_PLL1QEN) == (RCC_PLL1CFGR_PLL1QEN)) ? 1UL : 0UL);
}
...
{
  MV_SET_BIT(RCC->PLL1CFGR, RCC_PLL1CFGR_PLL1REN);
}
...
{
  MV_CLEAR_BIT(RCC->PLL1CFGR, RCC_PLL1CFGR_PLL1REN);
}
...
{
  return ((MV_READ_BIT(RCC->PLL1CFGR, RCC_PLL1CFGR_PLL1REN) == (RCC_PLL1CFGR_PLL1REN)) ? 1UL : 0UL);
}
...
{
  MV_SET_BIT(RCC->PLL1CFGR, RCC_PLL1CFGR_PLL1FRACEN);
}
...
{
  return ((MV_READ_BIT(RCC->PLL1CFGR, RCC_PLL1CFGR_PLL1FRACEN) == RCC_PLL1CFGR_PLL1FRACEN) ? 1UL : 0UL);
}
...
{
  MV_CLEAR_BIT(RCC->PLL1CFGR, RCC_PLL1CFGR_PLL1FRACEN);
}
...
{
  MV_MODIFY_REG(RCC->PLL1FRACR, RCC_PLL1FRACR_PLL1FRACN, FRACN << RCC_PLL1FRACR_PLL1FRACN_Pos);
}
...
{
  return (uint32_t)(MV_READ_BIT(RCC->PLL1FRACR, RCC_PLL1FRACR_PLL1FRACN) >>  RCC_PLL1FRACR_PLL1FRACN_Pos);
}
...
{
  MV_MODIFY_REG(RCC->PLL1CFGR, RCC_PLL1CFGR_PLL1RGE, InputRange << RCC_PLL1CFGR_PLL1RGE_Pos);
}
...
{
  MV_MODIFY_REG(RCC->PLL1CFGR, RCC_PLL1CFGR_PLL1MBOOST, BoostDiv);
}
...
{
  return (uint32_t)(MV_READ_BIT(RCC->PLL1CFGR, RCC_PLL1CFGR_PLL1MBOOST));
}
...
{
  MV_SET_BIT(RCC->CR, RCC_CR_PLL2ON);
}
...
{
  MV_CLEAR_BIT(RCC->CR, RCC_CR_PLL2ON);
}
...
{
  return ((MV_READ_BIT(RCC->CR, RCC_CR_PLL2RDY) == RCC_CR_PLL2RDY) ? 1UL : 0UL);
}
...
{
  MV_MODIFY_REG(RCC->PLL2CFGR, RCC_PLL2CFGR_PLL2SRC | RCC_PLL2CFGR_PLL2M, Source | \
             ((PLLM - 1UL) << RCC_PLL2CFGR_PLL2M_Pos));
  MV_MODIFY_REG(RCC->PLL2DIVR, RCC_PLL2DIVR_PLL2N | RCC_PLL2DIVR_PLL2Q, ((PLLN - 1UL) << \
...
__STATIC_INLINE void LL_RCC_PLL2_ConfigDomain_SAI(uint32_t Source, uint32_t PLLM, uint32_t PLLN, uint32_t PLLP)
{
  MV_MODIFY_REG(RCC->PLL2CFGR, RCC_PLL2CFGR_PLL2SRC | RCC_PLL2CFGR_PLL2M, Source | \
             ((PLLM - 1UL) << RCC_PLL2CFGR_PLL2M_Pos));
  MV_MODIFY_REG(RCC->PLL2DIVR, RCC_PLL2DIVR_PLL2N | RCC_PLL2DIVR_PLL2P, ((PLLN - 1UL) << \
...
__STATIC_INLINE void LL_RCC_PLL2_ConfigDomain_ADC(uint32_t Source, uint32_t PLLM, uint32_t PLLN, uint32_t PLLR)
{
  MV_MODIFY_REG(RCC->PLL2CFGR, RCC_PLL2CFGR_PLL2SRC | RCC_PLL2CFGR_PLL2M, Source | \
             ((PLLM - 1UL) << RCC_PLL2CFGR_PLL2M_Pos));
  MV_MODIFY_REG(RCC->PLL2DIVR, RCC_PLL2DIVR_PLL2N | RCC_PLL2DIVR_PLL2R, ((PLLN - 1UL) << \
...
{
  MV_MODIFY_REG(RCC->PLL2CFGR, RCC_PLL2CFGR_PLL2SRC, PLL2Source);
}
...
{
  return (uint32_t)(MV_READ_BIT(RCC->PLL2CFGR, RCC_PLL2CFGR_PLL2SRC));
}
...
{
  MV_MODIFY_REG(RCC->PLL2DIVR, RCC_PLL2DIVR_PLL2N, (PLL2N - 1UL) << RCC_PLL2DIVR_PLL2N_Pos);
}
...
{
  return (uint32_t)((MV_READ_BIT(RCC->PLL2DIVR, RCC_PLL2DIVR_PLL2N) >>  RCC_PLL2DIVR_PLL2N_Pos) + 1UL);
}
...
{
  MV_MODIFY_REG(RCC->PLL2DIVR, RCC_PLL2DIVR_PLL2P, (PLL2P - 1UL) << RCC_PLL2DIVR_PLL2P_Pos);
}
...
{
  return (uint32_t)((MV_READ_BIT(RCC->PLL2DIVR, RCC_PLL2DIVR_PLL2P) >>  RCC_PLL2DIVR_PLL2P_Pos) + 1UL);
}
...
{
  MV_MODIFY_REG(RCC->PLL2DIVR, RCC_PLL2DIVR_PLL2Q, (PLL2Q - 1UL) << RCC_PLL2DIVR_PLL2Q_Pos);
}
...
{
  return (uint32_t)((MV_READ_BIT(RCC->PLL2DIVR, RCC_PLL2DIVR_PLL2Q) >>  RCC_PLL2DIVR_PLL2Q_Pos) + 1UL);
}
...
{
  MV_MODIFY_REG(RCC->PLL2DIVR, RCC_PLL2DIVR_PLL2R, (PLL2R - 1UL) << RCC_PLL2DIVR_PLL2R_Pos);
}
...
{
  MV_MODIFY_REG(RCC->PLL2CFGR, RCC_PLL2CFGR_PLL2M, (PLL2M - 1UL) << RCC_PLL2CFGR_PLL2M_Pos);
}
...
{
  return (uint32_t)((MV_READ_BIT(RCC->PLL2CFGR, RCC_PLL2CFGR_PLL2M) >>  RCC_PLL2CFGR_PLL2M_Pos) + 1UL);
}
...
{
  MV_SET_BIT(RCC->PLL2CFGR, RCC_PLL2CFGR_PLL2PEN);
}
...
{
  MV_CLEAR_BIT(RCC->PLL2CFGR, RCC_PLL2CFGR_PLL2PEN);
}
...
{
  return ((MV_READ_BIT(RCC->PLL2CFGR, RCC_PLL2CFGR_PLL2PEN) == (RCC_PLL2CFGR_PLL2PEN)) ? 1UL : 0UL);
}
...
{
  MV_SET_BIT(RCC->PLL2CFGR, RCC_PLL2CFGR_PLL2QEN);
}
...
{
  MV_CLEAR_BIT(RCC->PLL2CFGR, RCC_PLL2CFGR_PLL2QEN);
}
...
{
  return ((MV_READ_BIT(RCC->PLL2CFGR, RCC_PLL2CFGR_PLL2QEN) == (RCC_PLL2CFGR_PLL2QEN)) ? 1UL : 0UL);
}
...
{
  MV_SET_BIT(RCC->PLL2CFGR, RCC_PLL2CFGR_PLL2REN);
}
...
{
  MV_CLEAR_BIT(RCC->PLL2CFGR, RCC_PLL2CFGR_PLL2REN);
}
...
{
  return ((MV_READ_BIT(RCC->PLL2CFGR, RCC_PLL2CFGR_PLL2REN) == (RCC_PLL2CFGR_PLL2REN)) ? 1UL : 0UL);
}
...
{
  MV_SET_BIT(RCC->PLL2CFGR, RCC_PLL2CFGR_PLL2FRACEN);
}
...
{
  return ((MV_READ_BIT(RCC->PLL2CFGR, RCC_PLL2CFGR_PLL2FRACEN) == RCC_PLL2CFGR_PLL2FRACEN) ? 1UL : 0UL);
}
...
{
  MV_CLEAR_BIT(RCC->PLL2CFGR, RCC_PLL2CFGR_PLL2FRACEN);
}
...
{
  MV_MODIFY_REG(RCC->PLL2FRACR, RCC_PLL2FRACR_PLL2FRACN, FRACN << RCC_PLL2FRACR_PLL2FRACN_Pos);
}
...
{
  return (uint32_t)(MV_READ_BIT(RCC->PLL2FRACR, RCC_PLL2FRACR_PLL2FRACN) >>  RCC_PLL2FRACR_PLL2FRACN_Pos);
}
...
{
  MV_MODIFY_REG(RCC->PLL2CFGR, RCC_PLL2CFGR_PLL2RGE, InputRange << RCC_PLL2CFGR_PLL2RGE_Pos);
}
...
{
  MV_SET_BIT(RCC->CR, RCC_CR_PLL3ON);
}
...
{
  MV_CLEAR_BIT(RCC->CR, RCC_CR_PLL3ON);
}
...
{
  return ((MV_READ_BIT(RCC->CR, RCC_CR_PLL3RDY) == RCC_CR_PLL3RDY) ? 1UL : 0UL);
}
...
{
  MV_MODIFY_REG(RCC->PLL3CFGR, RCC_PLL3CFGR_PLL3SRC | RCC_PLL3CFGR_PLL3M, Source | \
             ((PLLM - 1UL) << RCC_PLL3CFGR_PLL3M_Pos));
  MV_MODIFY_REG(RCC->PLL3DIVR, RCC_PLL3DIVR_PLL3N | RCC_PLL3DIVR_PLL3P, ((PLLN - 1UL) << \
...
__STATIC_INLINE void LL_RCC_PLL3_ConfigDomain_48M(uint32_t Source, uint32_t PLLM, uint32_t PLLN, uint32_t PLLQ)
{
  MV_MODIFY_REG(RCC->PLL3CFGR, RCC_PLL3CFGR_PLL3SRC | RCC_PLL3CFGR_PLL3M, Source | \
             ((PLLM - 1UL) << RCC_PLL3CFGR_PLL3M_Pos));
  MV_MODIFY_REG(RCC->PLL3DIVR, RCC_PLL3DIVR_PLL3N | RCC_PLL3DIVR_PLL3Q, ((PLLN - 1UL) << \
...
__STATIC_INLINE void LL_RCC_PLL3_ConfigDomain_HSPI_LTDC(uint32_t Source, uint32_t PLLM, uint32_t PLLN, uint32_t PLLR)
{
  MV_MODIFY_REG(RCC->PLL3CFGR, RCC_PLL3CFGR_PLL3SRC | RCC_PLL3CFGR_PLL3M, Source | \
             ((PLLM - 1UL) << RCC_PLL3CFGR_PLL3M_Pos));
  MV_MODIFY_REG(RCC->PLL3DIVR, RCC_PLL3DIVR_PLL3N | RCC_PLL3DIVR_PLL3R, ((PLLN - 1UL) << \
...
{
  MV_MODIFY_REG(RCC->PLL3CFGR, RCC_PLL3CFGR_PLL3SRC, PLLSource);
}
...
{
  return (uint32_t)(MV_READ_BIT(RCC->PLL3CFGR, RCC_PLL3CFGR_PLL3SRC));
}
...
{
  MV_MODIFY_REG(RCC->PLL3DIVR, RCC_PLL3DIVR_PLL3N, (PLL3N - 1UL) << RCC_PLL3DIVR_PLL3N_Pos);
}
...
{
  return (uint32_t)((MV_READ_BIT(RCC->PLL3DIVR, RCC_PLL3DIVR_PLL3N) >>  RCC_PLL3DIVR_PLL3N_Pos) + 1UL);
}
...
{
  MV_MODIFY_REG(RCC->PLL3DIVR, RCC_PLL3DIVR_PLL3P, (PLL3P - 1UL) << RCC_PLL3DIVR_PLL3P_Pos);
}
...
{
  return (uint32_t)((MV_READ_BIT(RCC->PLL3DIVR, RCC_PLL3DIVR_PLL3P) >>  RCC_PLL3DIVR_PLL3P_Pos) + 1UL);
}
...
{
  MV_MODIFY_REG(RCC->PLL3DIVR, RCC_PLL3DIVR_PLL3Q, (PLL3Q - 1UL) << RCC_PLL3DIVR_PLL3Q_Pos);
}
...
{
  return (uint32_t)((MV_READ_BIT(RCC->PLL3DIVR, RCC_PLL3DIVR_PLL3Q) >>  RCC_PLL3DIVR_PLL3Q_Pos) + 1UL);
}
...
{
  MV_MODIFY_REG(RCC->PLL3DIVR, RCC_PLL3DIVR_PLL3R, (PLL3R - 1UL) << RCC_PLL3DIVR_PLL3R_Pos);
}
...
{
  return (uint32_t)((MV_READ_BIT(RCC->PLL3DIVR, RCC_PLL3DIVR_PLL3R) >>  RCC_PLL3DIVR_PLL3R_Pos) + 1UL);
}
...
{
  MV_MODIFY_REG(RCC->PLL3CFGR, RCC_PLL3CFGR_PLL3M, (PLL3M - 1UL) << RCC_PLL3CFGR_PLL3M_Pos);
}
...
{
  return (uint32_t)((MV_READ_BIT(RCC->PLL3CFGR, RCC_PLL3CFGR_PLL3M) >> RCC_PLL3CFGR_PLL3M_Pos) + 1UL);
}
...
{
  MV_SET_BIT(RCC->PLL3CFGR, RCC_PLL3CFGR_PLL3PEN);
}
...
{
  MV_CLEAR_BIT(RCC->PLL3CFGR, RCC_PLL3CFGR_PLL3PEN);
}
...
{
  return ((MV_READ_BIT(RCC->PLL3CFGR, RCC_PLL3CFGR_PLL3PEN) == (RCC_PLL3CFGR_PLL3PEN)) ? 1UL : 0UL);
}
...
{
  MV_SET_BIT(RCC->PLL3CFGR, RCC_PLL3CFGR_PLL3QEN);
}
...
{
  MV_CLEAR_BIT(RCC->PLL3CFGR, RCC_PLL3CFGR_PLL3QEN);
}
...
{
  return ((MV_READ_BIT(RCC->PLL3CFGR, RCC_PLL3CFGR_PLL3QEN) == (RCC_PLL3CFGR_PLL3QEN)) ? 1UL : 0UL);
}
...
{
  MV_SET_BIT(RCC->PLL3CFGR, RCC_PLL3CFGR_PLL3REN);
}
...
{
  MV_CLEAR_BIT(RCC->PLL3CFGR, RCC_PLL3CFGR_PLL3REN);
}
...
{
  return ((MV_READ_BIT(RCC->PLL3CFGR, RCC_PLL3CFGR_PLL3REN) == (RCC_PLL3CFGR_PLL3REN)) ? 1UL : 0UL);
}
...
{
  MV_SET_BIT(RCC->PLL3CFGR, RCC_PLL3CFGR_PLL3FRACEN);
}
...
{
  return ((MV_READ_BIT(RCC->PLL3CFGR, RCC_PLL3CFGR_PLL3FRACEN) == RCC_PLL3CFGR_PLL3FRACEN) ? 1UL : 0UL);
}
...
{
  MV_CLEAR_BIT(RCC->PLL3CFGR, RCC_PLL3CFGR_PLL3FRACEN);
}
...
{
  MV_MODIFY_REG(RCC->PLL3FRACR, RCC_PLL3FRACR_PLL3FRACN, FRACN << RCC_PLL3FRACR_PLL3FRACN_Pos);
}
...
{
  return (uint32_t)(MV_READ_BIT(RCC->PLL3FRACR, RCC_PLL3FRACR_PLL3FRACN) >>  RCC_PLL3FRACR_PLL3FRACN_Pos);
}
...
{
  MV_MODIFY_REG(RCC->PLL3CFGR, RCC_PLL3CFGR_PLL3RGE, InputRange << RCC_PLL3CFGR_PLL3RGE_Pos);
}
...
__STATIC_INLINE void LL_RCC_EnablePrivilegedMode(void)
{
  ...
  MV_SET_BIT(RCC->PRIVCFGR, RCC_PRIVCFGR_SPRIV);
#else
  MV_SET_BIT(RCC->PRIVCFGR, RCC_PRIVCFGR_NSPRIV);
...
{
#if defined (__ARM_FEATURE_CMSE) && (__ARM_FEATURE_CMSE == 3U)
  MV_CLEAR_BIT(RCC->PRIVCFGR, RCC_PRIVCFGR_SPRIV);
#else
  MV_CLEAR_BIT(RCC->PRIVCFGR, RCC_PRIVCFGR_NSPRIV);
#endif /* __ARM_FEATURE_CMSE && (__ARM_FEATURE_CMSE == 3U) */
}
...
{
#if defined (__ARM_FEATURE_CMSE) && (__ARM_FEATURE_CMSE == 3U)
  return ((MV_READ_BIT(RCC->PRIVCFGR, RCC_PRIVCFGR_SPRIV) == RCC_PRIVCFGR_SPRIV) ? 1UL : 0UL);
#else
  return ((MV_READ_BIT(RCC->PRIVCFGR, RCC_PRIVCFGR_NSPRIV) == RCC_PRIVCFGR_NSPRIV) ? 1UL : 0UL);
#endif /* __ARM_FEATURE_CMSE && (__ARM_FEATURE_CMSE == 3U) */
}
...
{
  MV_SET_BIT(RCC->CICR, RCC_CICR_LSIRDYC);
}
...
{
  MV_SET_BIT(RCC->CICR, RCC_CICR_LSERDYC);
}
...
{
  MV_SET_BIT(RCC->CICR, RCC_CICR_MSISRDYC);
}
...
{
  MV_SET_BIT(RCC->CICR, RCC_CICR_HSIRDYC);
}
...
{
  MV_SET_BIT(RCC->CICR, RCC_CICR_HSERDYC);
}
...
{
  MV_SET_BIT(RCC->CICR, RCC_CICR_HSI48RDYC);
}
...
{
  MV_SET_BIT(RCC->CICR, RCC_CICR_PLL1RDYC);
}
...
{
  MV_SET_BIT(RCC->CICR, RCC_CICR_PLL2RDYC);
}
...
{
  MV_SET_BIT(RCC->CICR, RCC_CICR_PLL3RDYC);
}
...
{
  MV_SET_BIT(RCC->CICR, RCC_CICR_CSSC);
}
...
{
  MV_SET_BIT(RCC->CICR, RCC_CICR_MSIKRDYC);
}
...
{
  MV_SET_BIT(RCC->CICR, RCC_CICR_SHSIRDYC);
}
#endif /*(__ARM_FEATURE_CMSE) && (__ARM_FEATURE_CMSE == 3U)*/
...
{
  return ((MV_READ_BIT(RCC->CIFR, RCC_CIFR_LSIRDYF) == RCC_CIFR_LSIRDYF) ? 1UL : 0UL);
}
...
{
  return ((MV_READ_BIT(RCC->CIFR, RCC_CIFR_LSERDYF) == RCC_CIFR_LSERDYF) ? 1UL : 0UL);
}
...
{
  return ((MV_READ_BIT(RCC->CIFR, RCC_CIFR_MSISRDYF) == RCC_CIFR_MSISRDYF) ? 1UL : 0UL);
}
...
{
  return ((MV_READ_BIT(RCC->CIFR, RCC_CIFR_HSIRDYF) == RCC_CIFR_HSIRDYF) ? 1UL : 0UL);
}
...
{
  return ((MV_READ_BIT(RCC->CIFR, RCC_CIFR_HSERDYF) == RCC_CIFR_HSERDYF) ? 1UL : 0UL);
}
...
{
  return ((MV_READ_BIT(RCC->CIFR, RCC_CIFR_HSI48RDYF) == RCC_CIFR_HSI48RDYF) ? 1UL : 0UL);
}
/**
...
{
  return ((MV_READ_BIT(RCC->CIFR, RCC_CIFR_PLL1RDYF) == RCC_CIFR_PLL1RDYF) ? 1UL : 0UL);
}
...
{
  return ((MV_READ_BIT(RCC->CIFR, RCC_CIFR_PLL2RDYF) == RCC_CIFR_PLL2RDYF) ? 1UL : 0UL);
}
...
{
  return ((MV_READ_BIT(RCC->CIFR, RCC_CIFR_PLL3RDYF) == RCC_CIFR_PLL3RDYF) ? 1UL : 0UL);
}
...
{
  return ((MV_READ_BIT(RCC->CIFR, RCC_CIFR_CSSF) == RCC_CIFR_CSSF) ? 1UL : 0UL);
}
...
{
  return ((MV_READ_BIT(RCC->CIFR, RCC_CIFR_MSIKRDYF) == RCC_CIFR_MSIKRDYF) ? 1UL : 0UL);
}
...
{
  return ((MV_READ_BIT(RCC->CIFR, RCC_CIFR_SHSIRDYF) == RCC_CIFR_SHSIRDYF) ? 1UL : 0UL);
}
#endif /*(__ARM_FEATURE_CMSE) && (__ARM_FEATURE_CMSE == 3U)*/
...
{
  return ((MV_READ_BIT(RCC->CSR, RCC_CSR_IWDGRSTF) == RCC_CSR_IWDGRSTF) ? 1UL : 0UL);
}
...
{
  return ((MV_READ_BIT(RCC->CSR, RCC_CSR_LPWRRSTF) == RCC_CSR_LPWRRSTF) ? 1UL : 0UL);
}
...
{
  return ((MV_READ_BIT(RCC->CSR, RCC_CSR_OBLRSTF) == RCC_CSR_OBLRSTF) ? 1UL : 0UL);
}
...
{
  return ((MV_READ_BIT(RCC->CSR, RCC_CSR_PINRSTF) == RCC_CSR_PINRSTF) ? 1UL : 0UL);
}
...
{
  return ((MV_READ_BIT(RCC->CSR, RCC_CSR_SFTRSTF) == RCC_CSR_SFTRSTF) ? 1UL : 0UL);
}
...
{
  return ((MV_READ_BIT(RCC->CSR, RCC_CSR_WWDGRSTF) == RCC_CSR_WWDGRSTF) ? 1UL : 0UL);
}
...
{
  return ((MV_READ_BIT(RCC->CSR, RCC_CSR_BORRSTF) == RCC_CSR_BORRSTF) ? 1UL : 0UL);
}
...
{
  MV_SET_BIT(RCC->CSR, RCC_CSR_RMVF);
}
...
{
  MV_SET_BIT(RCC->CIER, RCC_CIER_LSIRDYIE);
}
...
{
  MV_SET_BIT(RCC->CIER, RCC_CIER_LSERDYIE);
}
...
{
  MV_SET_BIT(RCC->CIER, RCC_CIER_MSISRDYIE);
}
...
{
  MV_SET_BIT(RCC->CIER, RCC_CIER_HSIRDYIE);
}
...
{
  MV_SET_BIT(RCC->CIER, RCC_CIER_HSERDYIE);
}
...
{
  MV_SET_BIT(RCC->CIER, RCC_CIER_HSI48RDYIE);
}
...
{
  MV_SET_BIT(RCC->CIER, RCC_CIER_PLL1RDYIE);
}
...
{
  MV_SET_BIT(RCC->CIER, RCC_CIER_PLL2RDYIE);
}
...
{
  MV_SET_BIT(RCC->CIER, RCC_CIER_PLL3RDYIE);
}
...
{
  MV_SET_BIT(RCC->CIER, RCC_CIER_MSIKRDYIE);
}
...
{
  MV_SET_BIT(RCC->CIER, RCC_CIER_SHSIRDYIE);
}
#endif /*(__ARM_FEATURE_CMSE) && (__ARM_FEATURE_CMSE == 3U)*/
...
{
  MV_CLEAR_BIT(RCC->CIER, RCC_CIER_LSIRDYIE);
}
...
{
  MV_CLEAR_BIT(RCC->CIER, RCC_CIER_LSERDYIE);
}
...
{
  MV_CLEAR_BIT(RCC->CIER, RCC_CIER_MSISRDYIE);
}
...
{
  MV_CLEAR_BIT(RCC->CIER, RCC_CIER_HSIRDYIE);
}
...
{
  MV_CLEAR_BIT(RCC->CIER, RCC_CIER_HSERDYIE);
}
...
{
  MV_CLEAR_BIT(RCC->CIER, RCC_CIER_HSI48RDYIE);
}
...
{
  MV_CLEAR_BIT(RCC->CIER, RCC_CIER_PLL1RDYIE);
}
...
{
  MV_CLEAR_BIT(RCC->CIER, RCC_CIER_PLL2RDYIE);
}
...
{
  MV_CLEAR_BIT(RCC->CIER, RCC_CIER_PLL3RDYIE);
}
...
{
  MV_CLEAR_BIT(RCC->CIER, RCC_CIER_MSIKRDYIE);
}
...
{
  MV_CLEAR_BIT(RCC->CIER, RCC_CIER_SHSIRDYIE);
}
#endif /*(__ARM_FEATURE_CMSE) && (__ARM_FEATURE_CMSE == 3U)*/
...
{
  return ((MV_READ_BIT(RCC->CIER, RCC_CIER_LSIRDYIE) == RCC_CIER_LSIRDYIE) ? 1UL : 0UL);
}
...
{
  return ((MV_READ_BIT(RCC->CIER, RCC_CIER_LSERDYIE) == RCC_CIER_LSERDYIE) ? 1UL : 0UL);
}
...
{
  return ((MV_READ_BIT(RCC->CIER, RCC_CIER_MSISRDYIE) == RCC_CIER_MSISRDYIE) ? 1UL : 0UL);
}
...
{
  return ((MV_READ_BIT(RCC->CIER, RCC_CIER_HSIRDYIE) == RCC_CIER_HSIRDYIE) ? 1UL : 0UL);
}
...
{
  return ((MV_READ_BIT(RCC->CIER, RCC_CIER_HSERDYIE) == RCC_CIER_HSERDYIE) ? 1UL : 0UL);
}
...
{
  return ((MV_READ_BIT(RCC->CIER, RCC_CIER_HSI48RDYIE) == RCC_CIER_HSI48RDYIE) ? 1UL : 0UL);
}
/**
...
{
  return ((MV_READ_BIT(RCC->CIER, RCC_CIER_PLL1RDYIE) == RCC_CIER_PLL1RDYIE) ? 1UL : 0UL);
}
...
{
  return ((MV_READ_BIT(RCC->CIER, RCC_CIER_PLL2RDYIE) == RCC_CIER_PLL2RDYIE) ? 1UL : 0UL);
}
...
{
  return ((MV_READ_BIT(RCC->CIER, RCC_CIER_PLL3RDYIE) == RCC_CIER_PLL3RDYIE) ? 1UL : 0UL);
}
...
{
  return ((MV_READ_BIT(RCC->CIER, RCC_CIER_MSIKRDYIE) == RCC_CIER_MSIKRDYIE) ? 1UL : 0UL);
}
...
{
  return ((MV_READ_BIT(RCC->CIER, RCC_CIER_SHSIRDYIE) == RCC_CIER_SHSIRDYIE) ? 1UL : 0UL);
}
#endif /*(__ARM_FEATURE_CMSE) && (__ARM_FEATURE_CMSE == 3U)*/
...
{
  MV_WRITE_REG(RCC->SECCFGR, SecureConfig);
}
#endif /* __ARM_FEATURE_CMSE && (__ARM_FEATURE_CMSE == 3U) */
...
{
  return (uint32_t)(MV_READ_BIT(RCC->SECCFGR, RCC_SECURE_MASK));
}
