...
/**
  ...
  * @retval None
  */
#define GPU2D_WriteReg(__INSTANCE__, __REG__, __VALUE__) MV_WRITE_REG(*(__IO uint32_t *)(__INSTANCE__\
                                                                   + __REG__), __VALUE__)
...
/**
  ...
  */
#define GPU2D_ReadReg(__INSTANCE__, __REG__) MV_READ_REG(*(__IO uint32_t *)(__INSTANCE__ + __REG__))
/**
  * @}
  */
