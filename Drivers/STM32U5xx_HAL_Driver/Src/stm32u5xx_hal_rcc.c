...
#define RCC_PLL_OSCSOURCE_CONFIG(__HAL_RCC_PLLSOURCE__) \
  (MV_MODIFY_REG(RCC->PLLCFGR, RCC_PLLCFGR_PLLSRC, (uint32_t)(__HAL_RCC_PLLSOURCE__)))
/**
  * @}
  */
...
HAL_StatusTypeDef HAL_RCC_DeInit(void)
{
  ...
  MV_MODIFY_REG(RCC->ICSCR1, RCC_ICSCR1_MSISRANGE, RCC_MSIRANGE_4);

  /* Set MSITRIM default value */
  MV_WRITE_REG(RCC->ICSCR2, 0x00084210U);

  /* Set MSIKRANGE default value */
  MV_MODIFY_REG(RCC->ICSCR1, RCC_ICSCR1_MSIKRANGE, RCC_MSIKRANGE_4);

  /* Set MSIRGSEL default value */
  MV_MODIFY_REG(RCC->ICSCR1, RCC_ICSCR1_MSIRGSEL, 0x0U);

  tickstart = HAL_GetTick();

  /* Reset CFGR register (MSI is selected as system clock source) */
  MV_CLEAR_REG(RCC->CFGR1);
  MV_CLEAR_REG(RCC->CFGR2);

  /* Wait till clock switch is ready */
  while (MV_READ_BIT(RCC->CFGR1, RCC_CFGR1_SWS) != 0U)
  {
  ...
  MV_CLEAR_BIT(RCC->CR, RCC_CR_MSIKON | RCC_CR_MSIPLLSEL | RCC_CR_MSIPLLFAST | RCC_CR_MSIKERON | RCC_CR_CSSON | \
  ...
  MV_CLEAR_BIT(RCC->CR, RCC_CR_HSEBYP | RCC_CR_HSEEXT);
  ...
  while (MV_READ_BIT(RCC->CR, RCC_CR_PLL1RDY) != 0U)
  {
  ...
  MV_CLEAR_REG(RCC->PLL1CFGR);

  /* Reset PLL1DIVR register */
  MV_WRITE_REG(RCC->PLL1DIVR, PLLDIVR_RESET_VALUE);

  /* Reset PLL1FRACR register */
  MV_CLEAR_REG(RCC->PLL1FRACR);

  /* Reset PLL2CFGR register */
  MV_CLEAR_REG(RCC->PLL2CFGR);

  /* Reset PLL2DIVR register */
  MV_WRITE_REG(RCC->PLL2DIVR, PLLDIVR_RESET_VALUE);

  /* Reset PLL2FRACR register */
  MV_CLEAR_REG(RCC->PLL2FRACR);

  /* Reset PLL3CFGR register */
  MV_CLEAR_REG(RCC->PLL3CFGR);

  /* Reset PLL3DIVR register */
  MV_WRITE_REG(RCC->PLL3DIVR, PLLDIVR_RESET_VALUE);

  /* Reset PLL3FRACR register */
  MV_CLEAR_REG(RCC->PLL3FRACR);

  /* Disable all interrupts */
  MV_CLEAR_REG(RCC->CIER);

  /* Clear all interrupts flags */
  MV_WRITE_REG(RCC->CICR, 0xFFFFFFFFU);
...
HAL_StatusTypeDef HAL_RCC_OscConfig(RCC_OscInitTypeDef  *pRCC_OscInitStruct)
{
  ...
  if (((pRCC_OscInitStruct->OscillatorType) & RCC_OSCILLATORTYPE_MSI) == RCC_OSCILLATORTYPE_MSI)
  {
    ...
    {
      if ((MV_READ_BIT(RCC->CR, RCC_CR_MSISRDY) != 0U) && (pRCC_OscInitStruct->MSIState == RCC_MSI_OFF))
      {
        return HAL_ERROR;
      }
  ...
  if (((pRCC_OscInitStruct->OscillatorType) & RCC_OSCILLATORTYPE_HSE) == RCC_OSCILLATORTYPE_HSE)
  {
    ...
    {
      if ((MV_READ_BIT(RCC->CR, RCC_CR_HSERDY) != 0U) && (pRCC_OscInitStruct->HSEState == RCC_HSE_OFF))
      {
        return HAL_ERROR;
      }
    }
  ...
  if (((pRCC_OscInitStruct->OscillatorType) & RCC_OSCILLATORTYPE_HSI) == RCC_OSCILLATORTYPE_HSI)
  {
        ...
        ((sysclk_source == RCC_SYSCLKSOURCE_STATUS_PLLCLK) && (pll_config == RCC_PLLSOURCE_HSI)))
    {
      ...
      if ((MV_READ_BIT(RCC->CR, RCC_CR_HSIRDY) != 0U) && (pRCC_OscInitStruct->HSIState == RCC_HSI_OFF))
      {
        return HAL_ERROR;
      }
  ...
  if (((pRCC_OscInitStruct->OscillatorType) & RCC_OSCILLATORTYPE_LSI) == RCC_OSCILLATORTYPE_LSI)
  {
    ...
    {
      uint32_t bdcr_temp = MV_READ_REG(RCC->BDCR);
      ...
      if (pRCC_OscInitStruct->LSIDiv != (bdcr_temp & RCC_BDCR_LSIPREDIV))
      {
        ...
        if ((bdcr_temp & RCC_BDCR_LSION) == RCC_BDCR_LSION)
        {
          ...
          while (MV_READ_BIT(RCC->BDCR, RCC_BDCR_LSIRDY) != 0U)
          {
        ...
        MV_MODIFY_REG(RCC->BDCR, RCC_BDCR_LSIPREDIV, pRCC_OscInitStruct->LSIDiv);
      }
  ...
  if (((pRCC_OscInitStruct->OscillatorType) & RCC_OSCILLATORTYPE_LSE) == RCC_OSCILLATORTYPE_LSE)
  {
    ...
    if (pRCC_OscInitStruct->LSEState != RCC_LSE_OFF)
    {
      ...
      if ((pRCC_OscInitStruct->LSEState & RCC_BDCR_LSESYSEN) != 0U)
      {
        ...
        while (MV_READ_BIT(RCC->BDCR, RCC_BDCR_LSESYSRDY) == 0U)
        {
          if ((HAL_GetTick() - tickstart) > RCC_LSE_TIMEOUT_VALUE)
          {
            return HAL_TIMEOUT;
    ...
    else
    {
      ...
      if (MV_READ_BIT(RCC->BDCR, RCC_BDCR_LSESYSEN) != 0U)
      {
  ...
  if (((pRCC_OscInitStruct->OscillatorType) & RCC_OSCILLATORTYPE_HSI48) == RCC_OSCILLATORTYPE_HSI48)
  {
    ...
    if (pRCC_OscInitStruct->HSI48State != RCC_HSI48_OFF)
    {
      ...
      while (MV_READ_BIT(RCC->CR, RCC_CR_HSI48RDY) == 0U)
      {
  ...
  if (((pRCC_OscInitStruct->OscillatorType) & RCC_OSCILLATORTYPE_SHSI) == RCC_OSCILLATORTYPE_SHSI)
  {
    ...
    if (pRCC_OscInitStruct->SHSIState != RCC_SHSI_OFF)
    {
      ...
      while (MV_READ_BIT(RCC->CR, RCC_CR_SHSIRDY) == 0U)
      {
  ...
  if (((pRCC_OscInitStruct->OscillatorType) & RCC_OSCILLATORTYPE_MSIK) == RCC_OSCILLATORTYPE_MSIK)
  {
    ...
    if (pRCC_OscInitStruct->MSIKState != RCC_MSIK_OFF)
    {
      ...
      while (MV_READ_BIT(RCC->CR, RCC_CR_MSIKRDY) == 0U)
      {
  ...
  if ((pRCC_OscInitStruct->PLL.PLLState) != RCC_PLL_NONE)
  {
    ...
    if (__HAL_RCC_GET_SYSCLK_SOURCE() != RCC_SYSCLKSOURCE_STATUS_PLLCLK)
    {
      if ((pRCC_OscInitStruct->PLL.PLLState) == RCC_PLL_ON)
      {
        ...
        if (MV_READ_BIT(PWR->VOSR, PWR_VOSR_BOOSTEN) == PWR_VOSR_BOOSTEN)
        {
          pwrboosten = SET;
        }
        MV_CLEAR_BIT(PWR->VOSR, PWR_VOSR_BOOSTEN);
        ...
        if (pwrboosten == SET)
        {
          ...
          MV_SET_BIT(PWR->VOSR, PWR_VOSR_BOOSTEN);
        }
    ...
    else
    {
      ...
      if (((pRCC_OscInitStruct->PLL.PLLState) == RCC_PLL_OFF) ||
          (MV_READ_BIT(temp1_pllckcfg, RCC_PLL1CFGR_PLL1SRC) != pRCC_OscInitStruct->PLL.PLLSource) ||
          ((MV_READ_BIT(temp1_pllckcfg, RCC_PLL1CFGR_PLL1M) >> \
            RCC_PLL1CFGR_PLL1M_Pos) != (pRCC_OscInitStruct->PLL.PLLM - 1U)) ||
          ((MV_READ_BIT(temp1_pllckcfg, RCC_PLL1CFGR_PLL1MBOOST) >> \
            RCC_PLL1CFGR_PLL1MBOOST_Pos) != pRCC_OscInitStruct->PLL.PLLMBOOST) ||
          (MV_READ_BIT(temp2_pllckcfg, RCC_PLL1DIVR_PLL1N) != (pRCC_OscInitStruct->PLL.PLLN - 1U)) ||
          ((MV_READ_BIT(temp2_pllckcfg, RCC_PLL1DIVR_PLL1P) >> \
            RCC_PLL1DIVR_PLL1P_Pos) != (pRCC_OscInitStruct->PLL.PLLP - 1U)) ||
          ((MV_READ_BIT(temp2_pllckcfg, RCC_PLL1DIVR_PLL1Q) >> \
            RCC_PLL1DIVR_PLL1Q_Pos) != (pRCC_OscInitStruct->PLL.PLLQ - 1U)) ||
          ((MV_READ_BIT(temp2_pllckcfg, RCC_PLL1DIVR_PLL1R) >> \
...
HAL_StatusTypeDef HAL_RCC_ClockConfig(const RCC_ClkInitTypeDef   *const pRCC_ClkInitStruct, uint32_t FLatency)
{
  ...
  {
    if ((pRCC_ClkInitStruct->APB3CLKDivider) > (MV_READ_REG(RCC->CFGR3) & RCC_CFGR3_PPRE3))
    {
      assert_param(IS_RCC_PCLK(pRCC_ClkInitStruct->APB3CLKDivider));
      MV_MODIFY_REG(RCC->CFGR3, RCC_CFGR3_PPRE3, pRCC_ClkInitStruct->APB3CLKDivider);
    }
  }
  /*-------------------------- PCLK2 Configuration ---------------------------*/
  if (((pRCC_ClkInitStruct->ClockType) & RCC_CLOCKTYPE_PCLK2) == RCC_CLOCKTYPE_PCLK2)
  {
    if ((pRCC_ClkInitStruct->APB2CLKDivider) > ((MV_READ_REG(RCC->CFGR2) & RCC_CFGR2_PPRE2) >> 4))
    {
      assert_param(IS_RCC_PCLK(pRCC_ClkInitStruct->APB2CLKDivider));
      MV_MODIFY_REG(RCC->CFGR2, RCC_CFGR2_PPRE2, ((pRCC_ClkInitStruct->APB2CLKDivider) << 4));
    }
  }
  ...
  {
    if ((pRCC_ClkInitStruct->APB1CLKDivider) > (MV_READ_REG(RCC->CFGR2) & RCC_CFGR2_PPRE1))
    {
      assert_param(IS_RCC_PCLK(pRCC_ClkInitStruct->APB1CLKDivider));
      MV_MODIFY_REG(RCC->CFGR2, RCC_CFGR2_PPRE1, pRCC_ClkInitStruct->APB1CLKDivider);
    }
  }
  ...
  {
    if ((pRCC_ClkInitStruct->AHBCLKDivider) > (MV_READ_REG(RCC->CFGR2) & RCC_CFGR2_HPRE))
    {
      assert_param(IS_RCC_HCLK(pRCC_ClkInitStruct->AHBCLKDivider));
      MV_MODIFY_REG(RCC->CFGR2, RCC_CFGR2_HPRE, pRCC_ClkInitStruct->AHBCLKDivider);
    }
  }
  ...
  if (((pRCC_ClkInitStruct->ClockType) & RCC_CLOCKTYPE_SYSCLK) == RCC_CLOCKTYPE_SYSCLK)
  {
    ...
    if (pRCC_ClkInitStruct->SYSCLKSource == RCC_SYSCLKSOURCE_PLLCLK)
    {
      ...
      if (MV_READ_BIT(PWR->VOSR, PWR_VOSR_BOOSTEN) != 0U)
      {
        /* Wait till BOOST is ready */
        while (MV_READ_BIT(PWR->VOSR, PWR_VOSR_BOOSTRDY) == 0U)
        {
      ...
      if (MV_READ_BIT(RCC->CR, RCC_CR_PLL1RDY) == 0U)
      {
        return HAL_ERROR;
      }
    }
    ...
    MV_MODIFY_REG(RCC->CFGR1, RCC_CFGR1_SW, pRCC_ClkInitStruct->SYSCLKSource);
  ...
  /* Update the SystemCoreClock global variable */
  SystemCoreClock = HAL_RCC_GetSysClockFreq() >> AHBPrescTable[(MV_READ_REG(RCC->CFGR2) & RCC_CFGR2_HPRE) >> RCC_CFGR2_HPRE_Pos];
...
void HAL_RCC_MCOConfig(uint32_t RCC_MCOx, uint32_t RCC_MCOSource, uint32_t RCC_MCODiv)
{
  ...
  MV_MODIFY_REG(RCC->CFGR1, (RCC_CFGR1_MCOSEL | RCC_CFGR1_MCOPRE), (RCC_MCOSource | RCC_MCODiv));
}
...
uint32_t HAL_RCC_GetSysClockFreq(void)
{
      ...
      ((sysclk_source == RCC_SYSCLKSOURCE_STATUS_PLLCLK) && (pll_oscsource == RCC_PLLSOURCE_MSI)))
  {
    ...
    if (MV_READ_BIT(RCC->ICSCR1, RCC_ICSCR1_MSIRGSEL) == 0U)
    {
      ...
      msirange = (MV_READ_REG(RCC->CSR) & RCC_CSR_MSISSRANGE) >> RCC_CSR_MSISSRANGE_Pos;
    }
    else
    {
      /* MSIRANGE from RCC_CR applies */
      msirange = (MV_READ_REG(RCC->ICSCR1) & RCC_ICSCR1_MSISRANGE) >> RCC_ICSCR1_MSISRANGE_Pos;
    }
  ...
  if (sysclk_source == RCC_SYSCLKSOURCE_STATUS_PLLCLK)
  {
    /* PLL used as system clock  source
       ...
       SYSCLK = PLL_VCO / PLLR
    */
    pllsource = (MV_READ_REG(RCC->PLL1CFGR) & RCC_PLL1CFGR_PLL1SRC);
    pllm = ((MV_READ_REG(RCC->PLL1CFGR) & RCC_PLL1CFGR_PLL1M) >> RCC_PLL1CFGR_PLL1M_Pos) + 1U;
    pllfracen = ((MV_READ_REG(RCC->PLL1CFGR) & RCC_PLL1CFGR_PLL1FRACEN) >> RCC_PLL1CFGR_PLL1FRACEN_Pos);
    fracn1 = (float_t)(uint32_t)(pllfracen * ((MV_READ_REG(RCC->PLL1FRACR) & RCC_PLL1FRACR_PLL1FRACN) >> \
    ...
    if (pllm != 0U)
    {
      switch (pllsource)
      {
        case RCC_PLLSOURCE_HSI:  /* HSI used as PLL clock source */
          pllvco = ((float_t)HSI_VALUE / (float_t)pllm) * ((float_t)(uint32_t)(MV_READ_REG(RCC->PLL1DIVR) & RCC_PLL1DIVR_PLL1N) + \
                                                           (fracn1 / (float_t)0x2000) + (float_t)1U);
          break;

        case RCC_PLLSOURCE_HSE:  /* HSE used as PLL clock source */
          pllvco = ((float_t)HSE_VALUE / (float_t)pllm) * ((float_t)(uint32_t)(MV_READ_REG(RCC->PLL1DIVR) & RCC_PLL1DIVR_PLL1N) + \
                                                           (fracn1 / (float_t)0x2000) + (float_t)1U);
          break;

        case RCC_PLLSOURCE_MSI:  /* MSI used as PLL clock source */
        default:
          pllvco = ((float_t) msirange / (float_t)pllm) * ((float_t)(uint32_t)(MV_READ_REG(RCC->PLL1DIVR) & RCC_PLL1DIVR_PLL1N) + \
                                                           (fracn1 / (float_t)0x2000) + (float_t)1U);
          break;
      }

      pllr = (((MV_READ_REG(RCC->PLL1DIVR) & RCC_PLL1DIVR_PLL1R) >> RCC_PLL1DIVR_PLL1R_Pos) + 1U);
...
uint32_t HAL_RCC_GetPCLK1Freq(void)
{
  ...
  return (HAL_RCC_GetHCLKFreq() >> APBPrescTable[(MV_READ_REG(RCC->CFGR2) & RCC_CFGR2_PPRE1) >> RCC_CFGR2_PPRE1_Pos]);
}
...
uint32_t HAL_RCC_GetPCLK2Freq(void)
{
  ...
  return (HAL_RCC_GetHCLKFreq() >> APBPrescTable[(MV_READ_REG(RCC->CFGR2) & RCC_CFGR2_PPRE2) >> RCC_CFGR2_PPRE2_Pos]);
}
...
{
  /* Get HCLK source and Compute PCLK2 frequency ---------------------------*/
  return (HAL_RCC_GetHCLKFreq() >> APBPrescTable[(MV_READ_REG(RCC->CFGR3) & RCC_CFGR3_PPRE3) >> RCC_CFGR3_PPRE3_Pos]);
}
/**
...
void HAL_RCC_GetOscConfig(RCC_OscInitTypeDef  *pRCC_OscInitStruct)
{
  ...
  if ((MV_READ_REG(RCC->CR) & (RCC_CR_HSEBYP | RCC_CR_HSEEXT)) == RCC_CR_HSEBYP)
  {
    pRCC_OscInitStruct->HSEState = RCC_HSE_BYPASS;
  }
  else if ((MV_READ_REG(RCC->CR) & (RCC_CR_HSEBYP | RCC_CR_HSEEXT)) == (RCC_CR_HSEBYP | RCC_CR_HSEEXT))
  {
    pRCC_OscInitStruct->HSEState = RCC_HSE_BYPASS_DIGITAL;
  }
  else if ((MV_READ_REG(RCC->CR) & RCC_CR_HSEON) == RCC_CR_HSEON)
  {
  ...
  if ((MV_READ_REG(RCC->CR) & RCC_CR_MSISON) == RCC_CR_MSISON)
  {
  ...
  pRCC_OscInitStruct->MSIClockRange = (uint32_t)((MV_READ_REG(RCC->CR) & RCC_ICSCR1_MSISRANGE));
  if (pRCC_OscInitStruct->MSIClockRange >= RCC_MSIRANGE_12)
  {
    pRCC_OscInitStruct->MSICalibrationValue = (uint32_t)((MV_READ_REG(RCC->ICSCR2) & RCC_ICSCR2_MSITRIM3) >> \
                                                         RCC_ICSCR2_MSITRIM3_Pos);
  }
  else if (pRCC_OscInitStruct->MSIClockRange >= RCC_MSIRANGE_8)
  {
    pRCC_OscInitStruct->MSICalibrationValue = (uint32_t)((MV_READ_REG(RCC->ICSCR2) & RCC_ICSCR2_MSITRIM2) >> \
                                                         RCC_ICSCR2_MSITRIM2_Pos);
  }
  else if (pRCC_OscInitStruct->MSIClockRange >= RCC_MSIRANGE_4)
  {
    pRCC_OscInitStruct->MSICalibrationValue = (uint32_t)((MV_READ_REG(RCC->ICSCR2) & RCC_ICSCR2_MSITRIM1) >> \
                                                         RCC_ICSCR2_MSITRIM1_Pos);
  }
  else /*if (pRCC_OscInitStruct->MSIClockRange >= RCC_MSIRANGE_0)*/
  {
    pRCC_OscInitStruct->MSICalibrationValue = (uint32_t)((MV_READ_REG(RCC->ICSCR2) & RCC_ICSCR2_MSITRIM0) >> \
                                                         RCC_ICSCR2_MSITRIM0_Pos);
  }

  /* Get the HSI configuration -----------------------------------------------*/
  if ((MV_READ_REG(RCC->CR) & RCC_CR_HSION) == RCC_CR_HSION)
  {
  ...
  pRCC_OscInitStruct->HSICalibrationValue = (uint32_t)((MV_READ_REG(RCC->ICSCR3) & RCC_ICSCR3_HSITRIM) >> RCC_ICSCR3_HSITRIM_Pos);

  /* Get the LSE configuration -----------------------------------------------*/
  if ((MV_READ_REG(RCC->BDCR) & RCC_BDCR_LSEBYP) == RCC_BDCR_LSEBYP)
  {
    pRCC_OscInitStruct->LSEState = RCC_LSE_BYPASS;
  }
  else if ((MV_READ_REG(RCC->BDCR) & RCC_BDCR_LSEON) == RCC_BDCR_LSEON)
  {
  ...
  if ((MV_READ_REG(RCC->BDCR) & RCC_BDCR_LSION) == RCC_BDCR_LSION)
  {
  ...
  if ((MV_READ_REG(RCC->CR) & RCC_CR_HSI48ON) == RCC_CR_HSI48ON)
  {
  ...
  if ((MV_READ_REG(RCC->CR) & RCC_CR_PLL1ON) == RCC_CR_PLL1ON)
  {
  ...
  pRCC_OscInitStruct->PLL.PLLSource = (uint32_t)(MV_READ_REG(RCC->PLL1CFGR) & RCC_PLL1CFGR_PLL1SRC);
  pRCC_OscInitStruct->PLL.PLLM = (uint32_t)(((MV_READ_REG(RCC->PLL1CFGR) & RCC_PLL1CFGR_PLL1M) >> RCC_PLL1CFGR_PLL1M_Pos) + 1U);
  pRCC_OscInitStruct->PLL.PLLN = (uint32_t)(((MV_READ_REG(RCC->PLL1DIVR) & RCC_PLL1DIVR_PLL1N) >> RCC_PLL1DIVR_PLL1N_Pos) + 1U);
  pRCC_OscInitStruct->PLL.PLLQ = (uint32_t)(((MV_READ_REG(RCC->PLL1DIVR) & RCC_PLL1DIVR_PLL1Q) >> RCC_PLL1DIVR_PLL1Q_Pos) + 1U);
  pRCC_OscInitStruct->PLL.PLLR = (uint32_t)(((MV_READ_REG(RCC->PLL1DIVR) & RCC_PLL1DIVR_PLL1R) >> RCC_PLL1DIVR_PLL1R_Pos) + 1U);
  pRCC_OscInitStruct->PLL.PLLP = (uint32_t)(((MV_READ_REG(RCC->PLL1DIVR) & RCC_PLL1DIVR_PLL1P) >> RCC_PLL1DIVR_PLL1P_Pos) + 1U);
  pRCC_OscInitStruct->PLL.PLLRGE = (uint32_t)((MV_READ_REG(RCC->PLL1CFGR) & RCC_PLL1CFGR_PLL1RGE));
  pRCC_OscInitStruct->PLL.PLLFRACN = (uint32_t)(((MV_READ_REG(RCC->PLL1FRACR) & RCC_PLL1FRACR_PLL1FRACN) >> \
                                                 RCC_PLL1FRACR_PLL1FRACN_Pos));
  pRCC_OscInitStruct->PLL.PLLMBOOST = (uint32_t)(((MV_READ_REG(RCC->PLL1CFGR) & RCC_PLL1CFGR_PLL1MBOOST) >> \
...
void HAL_RCC_GetClockConfig(RCC_ClkInitTypeDef  *pRCC_ClkInitStruct, uint32_t *pFLatency)
{
  ...
  pRCC_ClkInitStruct->SYSCLKSource = (uint32_t)(MV_READ_REG(RCC->CFGR1) & RCC_CFGR1_SW);

  /* Get the HCLK configuration ----------------------------------------------*/
  pRCC_ClkInitStruct->AHBCLKDivider = (uint32_t)(MV_READ_REG(RCC->CFGR2) & RCC_CFGR2_HPRE);

  /* Get the APB1 configuration ----------------------------------------------*/
  pRCC_ClkInitStruct->APB1CLKDivider = (uint32_t)(MV_READ_REG(RCC->CFGR2) & RCC_CFGR2_PPRE1);

  /* Get the APB2 configuration ----------------------------------------------*/
  pRCC_ClkInitStruct->APB2CLKDivider = (uint32_t)((MV_READ_REG(RCC->CFGR2) & RCC_CFGR2_PPRE2) >> 4);
