...
ErrorStatus LL_RCC_DeInit(void)
{
  ...
  MV_CLEAR_BIT(vl_mask, (RCC_CR_HSION | RCC_CR_HSIKERON  | RCC_CR_HSEON |
  ...
  //while (MV_READ_BIT(RCC->CR, RCC_CR_PLL1RDY | RCC_CR_PLL2RDY | RCC_CR_PLL3RDY) != 0U)
  while ((LL_RCC_ReadReg(CR) & (RCC_CR_PLL1RDY | RCC_CR_PLL2RDY | RCC_CR_PLL3RDY)) != 0U)
  {
  }
